import { _ as _export_sfc, u as useGlobalStore, o as openBlock, c as createElementBlock, a as createBaseVNode, t as toDisplayString, e as createCommentVNode, n as normalizeStyle, d as normalizeClass, a9 as defineComponent, aa as isReactive, ab as h$5, ac as Teleport, F as Fragment } from "./app_emundus.js";
const _sfc_main = {
  name: "EventDay",
  props: {
    calendarEvent: {
...
const Qi = defineComponent({
  ...
  mounted() {
    ...
    for (const [t2, n2] of Object.entries(e2))
      this.calendarApp._setCustomComponentFn(t2, Gt(this.setCustomComponentMeta, n2));
...
var ve, h$4, _t, ft, U$1, Ve, ht, we, pt, $e, Se, Me, vt, ee = {}, mt = [], qt = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, me = Array.isArray;
function F$2(e2, t2) {
...
function je(e2, t2, n2) {
  t2[0] == "-" ? e2.setProperty(t2, n2 ?? "") : e2[t2] = n2 == null ? "" : typeof n2 != "number" || qt.test(t2) ? n2 : n2 + "px";
}
function ae(e2, t2, n2, r2, i2) {
  var o2;
  e: if (t2 == "style") if (typeof n2 == "string") e2.style.cssText = n2;
  else {
    if (typeof r2 == "string" && (e2.style.cssText = r2 = ""), r2) for (t2 in r2) n2 && t2 in n2 || je(e2.style, t2, "");
    if (n2) for (t2 in n2) r2 && n2[t2] === r2[t2] || je(e2.style, t2, n2[t2]);
  }
...
function Fe(e2, t2, n2, r2, i2, o2, a2, s2, l2, d2) {
  var _2, u2, c2, f2, m2, v2, b2, y2, k2, J2, A2, ie, G2, Re, oe, De, ke, T2 = t2.type;
  ...
  e: if (typeof T2 == "function") try {
    ...
    if (u2.context = A2, u2.props = y2, u2.__P = e2, u2.__e = false, G2 = h$4.__r, Re = 0, k2) {
  ...
  else o2 == null && t2.__v == n2.__v ? (t2.__k = n2.__k, t2.__e = n2.__e) : s2 = t2.__e = en$1(n2.__e, t2, n2, r2, i2, o2, a2, l2, d2);
  return (_2 = h$4.diffed) && _2(t2), 128 & t2.__u ? void 0 : s2;
}
function gt(e2, t2, n2) {
  for (var r2 = 0; r2 < n2.length; r2++) We(n2[r2], n2[++r2], n2[++r2]);
...
function en$1(e2, t2, n2, r2, i2, o2, a2, s2, l2) {
...
function bt(e2, t2, n2) {
  var r2, i2;
  if (h$4.unmount && h$4.unmount(e2), (r2 = e2.ref) && (r2.current && r2.current !== e2.__e || We(r2, null, t2)), (r2 = e2.__c) != null) {
...
}, C$2.prototype.render = M$1, U$1 = [], ht = typeof Promise == "function" ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, we = function(e2, t2) {
...
P$2.__b = function(e2) {
  ...
  Je && Je(e2);
  var t2 = e2.__c;
  t2 && t2.__H && (t2.__H.__h.length && (Pt.push(t2) !== 1 && ze === P$2.requestAnimationFrame || ((ze = P$2.requestAnimationFrame) || sn$1)(an$1)), t2.__H.__.forEach(function(n2) {
...
function Yt(e2, t2, n2) {
  ...
  }), e2.__c.__H = null), (e2 = un$1({}, e2)).__c != null && (e2.__c.__P === n2 && (e2.__c.__P = t2), e2.__c = null), e2.__k = e2.__k && e2.__k.map(function(r2) {
    return Yt(r2, t2, n2);
  })), e2;
}
...
h$4.unmount = function(e2) {
  ...
  var i2 = t2.__a && j$3(M$1, null, e2.fallback);
  return i2 && (i2.__u &= -33), [j$3(M$1, null, t2.__a ? null : e2.children), i2];
};
...
var fn$1 = typeof Symbol < "u" && Symbol.for && Symbol.for("react.element") || 60103, hn = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image(!S)|letter|lighting|marker(?!H|W|U)|overline|paint|pointer|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/, pn = /^on(Ani|Tra|Tou|BeforeInp|Compo)/, vn = /[A-Z0-9]/g, mn = typeof document < "u", yn = function(e2) {
...
h$4.event = function(e2) {
  return it && (e2 = it(e2)), e2.persist = Dn, e2.isPropagationStopped = kn, e2.isDefaultPrevented = gn, e2.nativeEvent = e2;
};
var bn = { enumerable: false, configurable: true, get: function() {
  return this.class;
} }, ot = h$4.vnode;
h$4.vnode = function(e2) {
  typeof e2.type == "string" && function(t2) {
    ...
    for (var a2 in n2) {
      var s2 = n2[a2];
      if (!(a2 === "value" && "defaultValue" in n2 && s2 == null || mn && a2 === "children" && r2 === "noscript" || a2 === "class" || a2 === "className")) {
        var l2 = a2.toLowerCase();
        a2 === "defaultValue" && "value" in n2 && n2.value == null ? a2 = "value" : a2 === "download" && s2 === true ? s2 = "" : l2 === "translate" && s2 === "no" ? s2 = false : l2[0] === "o" && l2[1] === "n" ? l2 === "ondoubleclick" ? a2 = "ondblclick" : l2 !== "onchange" || r2 !== "input" && r2 !== "textarea" || yn(n2.type) ? l2 === "onfocus" ? a2 = "onfocusin" : l2 === "onblur" ? a2 = "onfocusout" : pn.test(a2) && (a2 = l2) : l2 = a2 = "oninput" : o2 && hn.test(a2) ? a2 = a2.replace(vn, "-$&").toLowerCase() : s2 === null && (s2 = void 0), l2 === "oninput" && i2[a2 = l2] && (a2 = "oninputCapture"), i2[a2] = s2;
      }
    }
    ...
    })), n2.class && !n2.className ? (i2.class = n2.class, Object.defineProperty(i2, "className", bn)) : (n2.className && !n2.class || n2.class && n2.className) && (i2.class = i2.className = n2.className), t2.props = i2;
  }(e2), e2.$$typeof = fn$1, ot && ot(e2);
};
var at = h$4.__r;
h$4.__r = function(e2) {
  at && at(e2), e2.__c;
...
function Ue() {
  if (V$2 > 1)
    ...
    if (Le = 0, V$2--, t2) throw e2;
  }
}
var D$2 = void 0, Q$1 = void 0, V$2 = 0, Le = 0, he = 0;
function Et(e2) {
  if (D$2 !== void 0) {
    var t2 = e2.n;
...
(B$3.prototype = new w$3()).h = function() {
...
function Sn(e2) {
  ...
  Ct(this), D$2 = e2, this.f &= -2, 8 & this.f && Ie(this), Ue();
}
function ne(e2) {
...
ne.prototype.S = function() {
  if (1 & this.f) throw new Error("Cycle detected");
  this.f |= 1, this.f &= -9, Ot(this), Tt(this), V$2++;
  var e2 = D$2;
  return D$2 = this, Sn.bind(this, e2);
};
...
function $t(e2) {
  var t2 = this, n2 = e2.data, r2 = Yn(n2);
  r2.value = n2;
  var i2 = wt(function() {
  ...
  if (typeof t2.type == "string" && (n2 = t2.__e)) {
    ...
    if (r2) {
      ...
      for (var l2 in r2) {
        ...
        d2 === void 0 ? (d2 = Mn(n2, l2, _2, i2), o2[l2] = d2) : d2.o(_2, i2);
      }
    }
  }
  e2(t2);
