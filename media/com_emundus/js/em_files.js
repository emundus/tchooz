                    ...
                    success: function(result) {
                        if (result.status) {
                            ...
                            $('#data').append('' +
                                ...
                                '<div>' +
                                '<h5>'+Joomla.Text._('COM_EMUNDUS_CHOOSE_PRG')+'<span class="material-icons text-xxs text-red-500 mr-0" style="top: -5px;position: relative">emergency</span></h5>' +
                                '</div>' +
                            ...
                            $('#data').append( '<div id="methode" style="display: none" class="em-grid-2 em-mt-16">'+
                                ...
                                '<input type="radio" name="em-export-methode" id="em-export-methode" value="0"' + (defaultMethod === 0 ? ' checked'  : '') +'>' +Joomla.Text._('COM_EMUNDUS_CHOOSE_EXTRACTION_METHODE_AGGREGATE_DISTINCT')+
                                '<br/><input type="radio" name="em-export-methode" id="em-export-methode" value="2"' + (defaultMethod === 2 ? ' checked'  : '') +'>' +Joomla.Text._('COM_EMUNDUS_CHOOSE_EXTRACTION_METHODE_AGGREGATE')+
                                '<br/><input type="radio" name="em-export-methode" id="em-export-methode" value="1"' + (defaultMethod === 1 ? ' checked'  : '') +'>' +Joomla.Text._('COM_EMUNDUS_CHOOSE_EXTRACTION_METHODE_LEFTJOIN')+ '<br>'+
                                '</form></div></div></div>'+
