...
"use strict";
    ...
    var textdecoded = "no";
	var ownip = Joomla.getOptions("securitycheckpro.Firewallconfig.currentip", 0);
	var dynamic_blacklist_message = Joomla.getOptions("securitycheckpro.Firewallconfig.dynamicblacklistText");
    ...
    jQuery(document).ready(function() {        
		...
		jQuery( "#dynamic_blacklist" ).change(function() {
			var dynamic_blacklist_status = jQuery("#dynamic_blacklist").val();
			if (dynamic_blacklist_status==0)
			{
				jQuery('#redirect_after_attack').val(0).trigger("chosen:updated");				
