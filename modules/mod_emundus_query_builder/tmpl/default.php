...
<div>
    <button id="buttonOpen" class="btnQueryBuilder" onclick="openCloseGraphManager()"><?php if (isset($_GET['gOpen'])) {
			echo JText::_('CLOSE_QUERY_BUILDER');
		} else {
			echo JText::_('OPEN_QUERY_BUILDER');
		} ?></button>
    <br/><br/>
    <div class="queryBuilder" style="display:<?php if (isset($_GET['gOpen'])) {
		echo "block;";
	} else {
		echo "none;";
	} ?>">
        <form action="" method="POST" onsubmit="return false;">
            ...
            <div class="createModule" id="createModule" style="display:none;">
                <input type="text" id="titleModule"
                       placeholder="<?php echo JText::_('MOD_EMUNDUS_QUERY_BUILDER_TITLE_MODULE'); ?>*"/>
                <div class="flexS">
                ...
                <div class="flexS">
                    <input type="text" id="axeXModule"
                           placeholder="<?php echo JText::_('MOD_EMUNDUS_QUERY_BUILDER_AXE_X_MODULE'); ?>*"/>
                    <input type="text" id="axeYModule"
                           placeholder="<?php echo JText::_('MOD_EMUNDUS_QUERY_BUILDER_AXE_Y_MODULE'); ?>*"/>
                </div>
                <input type="text" id="progModule"
                       placeholder="<?php echo JText::_('MOD_EMUNDUS_QUERY_BUILDER_PROGRAM_LABEL'); ?>"/>
                <div class="flexS">
                    <input type="text" id="yearModule"
                           placeholder="<?php echo JText::_('MOD_EMUNDUS_QUERY_BUILDER_YEAR_LABEL'); ?>"/>
                    <input type="text" id="campaignModule"
                           placeholder="<?php echo JText::_('MOD_EMUNDUS_QUERY_BUILDER_CAMPAIGN_LABEL'); ?>"/>
                </div>
                <div id="errorCreateModule"></div>
            </div>
            <input type="button" name="validation" class="btnQueryBuilder" id="validation"
                   style="float:right;display:none;"
                   value="<?php echo JText::_('MOD_EMUNDUS_QUERY_BUILDER_VALIDATION'); ?>" onclick="createModule()"/>
            <input type="button" id="createButton" class="btnQueryBuilder" style="float:right;"
                   value="<?php echo JText::_('MOD_EMUNDUS_QUERY_BUILDER_CREATE_MODULE'); ?>"
                   onclick="buttonCreateModule()"/>
			<?php if (!empty($gotenberg_activation)) : ?>
                <button onclick="getExport()" class="btnExport"
                        style="float:left;"> <?php echo JText::_('MOD_EMUNDUS_QUERY_BUILDER_EXPORT_MODULE'); ?></button>
			<?php endif; ?>
        </form>
    </div>
</div>
