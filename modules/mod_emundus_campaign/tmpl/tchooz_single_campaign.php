...
<div class="mod_emundus_campaign__grid em-mt-24 em-mb-64" style="grid-gap: 64px">
    <div>
        <button type="button"
                class="tw-text-link-regular tw-cursor-pointer tw-font-semibold tw-flex tw-items-center tw-group em-mb-12 em-w-max-content"
            ...
            <div class="mod_emundus_campaign__details_content em-border-neutral-300 em-mb-24">
				...
				<?php if ($mod_em_campaign_show_registration == 1 && !empty($mod_em_campaign_show_registration_steps)) : ?>
                    <div class="em-mt-24">
						...
						<?php foreach ($mod_em_campaign_show_registration_steps as $key => $step): ?>
                            ...
                            <span
                                class="em-applicant-text-color em-flex-row em-font-size-14 em-mb-16 em-profile-font"><span
				...
				<?php if ($can_apply == 1) : ?>
					...
					else
					{
						...
						{
							$params['course']             = $currentCampaign->parent_code;
							$params['application_choice'] = $currentCampaign->id;
							$params['cid']                = $currentCampaign->parent_id;
						}
                ...
                <div class="em-mt-24">
					<?php foreach ($files as $file) : ?>
                        <div class="em-flex-row em-mb-16 mod_emundus_campaign__details_file">
                            <span class="material-symbols-outlined mod_emundus_campaign__details_file_icon"
                                  aria-hidden="true">insert_drive_file</span>
