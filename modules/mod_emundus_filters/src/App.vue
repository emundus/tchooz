  ...
  <div id="emundus-filters" class="em-w-100">
    ...
    <section id="applied-filters">
      <div v-for="appliedFilter in appliedFilters" :key="appliedFilter.uid">
        ...
        <DefaultFilter v-else :filter="appliedFilter" :module-id="moduleId" :type="appliedFilter.type" class="em-w-100" @remove-filter="onRemoveFilter(appliedFilter)" @filter-changed="onFilterChanged"></DefaultFilter>
      </div>
    </section>
    ...
    <section id="filters-bottom-actions">
      <button id="em-add-filter" class="tw-btn-secondary tw-w-full em-white-bg em-mt-16" @click="openFilterOptions = !openFilterOptions">{{ translate('MOD_EMUNDUS_FILTERS_ADD_FILTER') }}</button>
