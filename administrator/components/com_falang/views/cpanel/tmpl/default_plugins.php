...
<table class="adminlist  table table-striped">
	<?php $i = 0; ?>
	<tr>
    <th style="width:200px;"><?php echo Text::_('COM_FALANG_CPANEL_PLUGIN_NAME'); ?></th>
    <th style="width:200px;"><?php echo Text::_('COM_FALANG_CPANEL_CURRENT_VERSION'); ?></th>
    <th style="width:130px;"><?php echo Text::_('COM_FALANG_CPANEL_LATEST_VERSION'); ?></th>
    <th>&nbsp;</th>
	</tr>
	<?php foreach ($this->pluginsInfos as $plugin => $values) : ?>
        <tr id="row_<?php echo $plugin; ?>" class="row<?php echo $i % 2; ?>">
            <th  style="text-align: left;"><?php echo Text::_($values['title']); ?></th>
            <td><?php
				...
				{ ?>
                    ...
                    - <a
                        ...
                        target="_blank" alt="download"><?php echo Text::_('COM_FALANG_DOWNLOAD_PLUGIN_LINK'); ?></a>
				<?php }
				else
				...
				{
					echo Text::_('COM_FALANG_ONLY_PAID');
				}
				else
				{ ?>
                    <i class="fa fa-times fa-danger"></i>
				...
				<?php 	if ($values['installed'] == 1) { ?>
                    <span class="new_version_link" style="display: none">
                     ...
                     <a href="http://www.faboba.com/index.php?option=com_ars&view=release&id=<?php echo $values['ars_id']; ?>"
                        target="_blank" alt="download"><?php echo Text::_('COM_FALANG_DOWNLOAD_PLUGIN_LINK_UPDATE'); ?></a>
                     </span>
				<?php } else { ?>
                    &nbsp;
				<?php } ?>
