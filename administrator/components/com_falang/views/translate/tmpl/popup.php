...
<header style="height: 27px; margin-bottom: 10px;">
    <div class="btn-group pull-left">
        <button type="button" onclick="Joomla.submitform('translation.apply', document.getElementById('component-form'));" class="btn btn-small btn-success"><?php echo Text::_('JAPPLY');?></button>
    </div>
</header>
