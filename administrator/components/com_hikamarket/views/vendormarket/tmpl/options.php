...
<?php if(empty($this->vendor->vendor_id) || $this->vendor->vendor_id > 1) { ?>
	...
	<dd class="hikamarket_vendor_opt_invoice"><?php
		if(hikashop_level(1)) {
			...
			?><input class="form-control" type="text" name="data[vendor][vendor_params][invoice_number_format]" value="<?php echo $this->escape($format); ?>" id="data_vendor_vendor_params_invoice_number_format"/><?php
		} else {
