...
<form action="index.php?option=<?php echo HIKAMARKET_COMPONENT ?>&amp;ctrl=<?php echo hikaInput::get()->getCmd('ctrl'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php } ?>
				...
				?></td>
				<td style="width:1%; text-align:center"><?php
					echo $row->vendor_id;
				?></td>
			</tr>
<?php
