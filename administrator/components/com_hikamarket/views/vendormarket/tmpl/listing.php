...
<?php
	...
	echo JHTML::_('select.genericlist', $values, 'filter_vendors_unpaid', ' class="custom-select" onchange="this.form.submit();"', 'value', 'text', @$this->pageInfo->filter->vendors_unpaid);
?>
	</div>
</div>
