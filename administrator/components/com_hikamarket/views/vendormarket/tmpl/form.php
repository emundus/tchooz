	...
	<div class="hkc-xl-4 hkc-lg-6 hikashop_tile_block"><div>
		...
		<dl class="hika_options">
			...
			<dd class="hikamarket_vendor_name input_large">
				<input type="text" class="form-control" name="data[vendor][vendor_name]" id="data[vendor][vendor_name]" value="<?php echo $this->escape(@$this->vendor->vendor_name); ?>" />
			</dd>
			...
			<dd class="hikamarket_vendor_email input_large">
				<input type="text" class="form-control" name="data[vendor][vendor_email]" id="data[vendor][vendor_email]" value="<?php echo $this->escape(@$this->vendor->vendor_email); ?>" />
			</dd>
...
?>
			...
			<dd class="hikamarket_vendor_alias input_large">
				<input type="text" class="form-control" name="data[vendor][vendor_alias]" id="data[vendor][vendor_alias]" value="<?php echo $this->escape(@$this->vendor->vendor_alias); ?>" />
			</dd>
...
<dl class="hika_options">
	...
	<dd class="hikamarket_vendor_location">
		<input type="text" class="form-control" id="vendor_location_lat" name="data[vendor][vendor_location_lat]" onchange="window.localPage.updateMapMarket();" value="<?php echo hikamarket::toFloat(@$this->vendor->vendor_location_lat); ?>" />
	</dd>
	<dt class="hikamarket_vendor_location"><label><?php echo JText::_('HIKAM_VENDOR_LOCATION_LONG'); ?></label></dt>
	<dd class="hikamarket_vendor_location">
		<input type="text" class="form-control" id="vendor_location_lon" name="data[vendor][vendor_location_long]" onchange="window.localPage.updateMapMarket();" value="<?php echo hikamarket::toFloat(@$this->vendor->vendor_location_long); ?>" />
	</dd>
</dl>
