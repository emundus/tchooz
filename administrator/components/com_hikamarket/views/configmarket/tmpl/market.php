...
<tr>
	...
	<td>
		<input type="text" class="form-control" name="config[prefix_product_code]" value="<?php echo $this->escape( @$this->config->get('prefix_product_code', '') ); ?>" />
	</td>
</tr>
...
<tr>
	...
	<td><?php
		echo JHTML::_('hikaselect.booleanlist', "config[allow_zone_vendor]", 'class="custom-select"', $this->config->get('allow_zone_vendor', 0));
	?></td>
</tr>
<tr>
	...
	<td><?php
		...
		echo JHTML::_('select.genericlist', $options, 'config[vendor_select_custom_field]', 'class="custom-select"', 'value', 'text', $this->config->get('vendor_select_custom_field', ''));
	?></td>
</tr>
<tr>
	...
	<td><?php
		...
		echo JHTML::_('select.genericlist', $options, 'config[preferred_vendor_select_custom_field]', 'class="custom-select"', 'value', 'text', $this->config->get('preferred_vendor_select_custom_field', ''));
	?></td>
</tr>
<tr class="option_title">
...
<tr>
	<td class="hk_tbl_key"<?php echo $this->docTip('div_item_layout_type');?>><?php echo JText::_('TYPE_OF_ITEM_LAYOUT');?></td>
	<td><?php
		echo $this->itemlayoutType->display('config[div_item_layout_type]', $this->config->get('div_item_layout_type', 'img_title'), $this->js, '', false);
	?></td>
</tr>
<tr>
...
<tr>
	...
	<td><?php
		echo $this->nameboxType->display(
			...
			explode(',', (string)$this->config->get('vendor_show_modules', '')),
			hikamarketNameboxType::NAMEBOX_MULTIPLE,
			'modules',
			array(
				'delete' => true,
...
<tr>
	...
	<td><?php
		...
		echo JHTML::_('select.genericlist', $options, 'config[allow_registration]', 'class="custom-select" onchange="window.localPage.allowRegistrationChanged(this);"', 'value', 'text', $this->config->get('allow_registration',0));
	?>
<?php
...
<tr>
	...
	<td>
		<input type="text" class="form-control" name="config[vendor_product_limitation]" value="<?php echo (int)$this->config->get('vendor_product_limitation', 0); ?>" />
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<input type="text" class="form-control" name="config[days_payment_request]" value="<?php echo (int)$this->config->get('days_payment_request', 0); ?>" />
	</td>
</tr>
<tr>
	<td class="hk_tbl_key"<?php echo $this->docTip('min_value_payment_request');?>><?php echo JText::_('MIN_VALUE_FOR_PAYMENT_REQUEST'); ?></td>
	<td>
		<input type="text" class="form-control" name="config[min_value_payment_request]" value="<?php echo hikamarket::toFloat($this->config->get('min_value_payment_request', 0.0)); ?>" />
