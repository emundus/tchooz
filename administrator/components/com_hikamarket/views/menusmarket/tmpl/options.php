...
?>
<div id="<?php echo $this->id; ?>" class="hikashop_backend_tile_edition hk-container-fluid <?php echo $joomla_version_class; ?>">
...
<dl class="hika_options large">
	...
	<dd id="<?php echo $this->id; ?>_columns_0">
		<input name="<?php echo $this->name; ?>[columns]" type="text" value="<?php echo @$this->element['columns'];?>" class="hk-form-control" />
	</dd>
	...
	?></dt>
	<dd>
		<input name="<?php echo $this->name; ?>[limit]" type="text" value="<?php echo @$this->element['limit'];?>" class="hk-form-control" />
	</dd>
...
<dl class="hikam_options large">
	...
	<dd>
		<div class="hk-input-group">
			<input type="text" class="hk-form-control" name="<?php echo $this->name; ?>[image_width]" value="<?php echo @$this->element['image_width'];?>"/>
	...
	<dd>
		<div class="hk-input-group">
			<input type="text" class="hk-form-control" name="<?php echo $this->name; ?>[image_height]" value="<?php echo @$this->element['image_height'];?>" />
			<div class="hk-input-group-append">
				<span class="hk-input-group-text">px</span>
			</div>
		</div>
	...
	<dd>
		<div class="hk-input-group">
			<input type="text" class="hk-form-control" name="<?php echo $this->name; ?>[image_radius]" value="<?php echo @$this->element['image_radius'];?>" />
			<div class="hk-input-group-append">
				<span class="hk-input-group-text">px</span>
			</div>
		</div>
...
<dl class="hikam_options large">
	...
	<dd>
		<div class="hk-input-group">
			<input type="text" class="hk-form-control" name="<?php echo $this->name; ?>[pane_height]" value="<?php echo @$this->element['pane_height'];?>" />
			<div class="hk-input-group-append">
				<span class="hk-input-group-text">px</span>
			</div>
		</div>
	...
	<dd>
		<div class="hk-input-group">
			<input type="text" class="hk-form-control" name="<?php echo $this->name; ?>[margin]" value="<?php echo @$this->element['margin'];?>"/>
			<div class="hk-input-group-append">
				<span class="hk-input-group-text">px</span>
			</div>
		</div>
...
<dl class="hikam_options large">
	...
	<dd>
		<input type="text" class="hk-form-control" name="<?php echo $this->name; ?>[ul_class_name]" value="<?php echo @$this->element['ul_class_name'];?>" />
	</dd>
</dl>
</div></div>
