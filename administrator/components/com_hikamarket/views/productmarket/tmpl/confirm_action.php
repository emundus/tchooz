...
?>
	...
	if($img->success) {
		...
		<label><input type="checkbox" name="cid[]" value="<?php echo (int)$product->product_id; ?>" checked="checked" onclick="Joomla.isChecked(this.checked);"/> <?php echo $product->product_code; ?></label>
...
?>
	...
	<input type="hidden" name="boxchecked" value="<?php echo count($this->products)-1; ?>" />
