...
<form action="<?php echo hikamarket::completeLink('mangopay'.$this->url_itemid);?>" method="post" name="hikamarket_form" id="hikamarket_mangopay_document_form" enctype="multipart/form-data">
	...
	<div>
		...
		<div style="float:right">
			<a class="btn btn-info" href="<?php echo hikamarket::completeLink('mangopay'.$this->url_itemid); ?>"><?php echo JText::_('HIKA_CANCEL'); ?></a>
		</div>
	</div>
