...
class hikamarketUpdateHelper {
	...
	public function installExtensions() {
		...
		$exts = array(
			...
			'plg_search_hikamarket_vendors' => array('Search - HikaMarket Vendors', 0, 0),
			'plg_finder_hikamarket' => array('Smart Search - HikaMarket Vendors', 0, 1),
	...
	public function addDefaultData() {
		...
		$elems = array(
			array('dashboard', 'icon-16-config.png', 'Dashboard', 'Dashboard'),
