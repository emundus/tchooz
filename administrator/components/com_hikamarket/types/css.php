...
class hikamarketCssType {
	...
	public function display($map, $type, $value) {
		...
		$html = JHTML::_('select.genericlist', $this->values, $map, 'class="custom-select" style="margin:0;display:inline-block;" size="1" onchange="var e=document.getElementById(\'hikamarket_css_'.$type.'_edit\');if(this.value==\'\'||this.value==\'default\'){e.style.display=\'none\';}else{e.style.display=\'\';}"', 'value', 'text', $value, 'css_'.$type.'_choice' );
