...
class Release2_4_4Installer extends ReleaseInstaller
{
	...
	public function install()
	{
		...
		try
		{
			...
			$query_fk         = 'ALTER TABLE jos_emundus_hikashop ADD CONSTRAINT jos_emundus_hikashop_ibfk_2 FOREIGN KEY (fnum) REFERENCES jos_emundus_campaign_candidature (fnum) ON UPDATE CASCADE ON DELETE SET NULL;';
			$this->db->setQuery($query_fk);
			$tasks[] = $this->db->execute();
