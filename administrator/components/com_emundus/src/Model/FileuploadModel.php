...
class FileuploadModel extends AdminModel
{
	...
	public function getItem($pk = null, )
	{
		...
		$query->select('upload.id, upload.fnum, upload.filename, upload.local_filename, upload.user_id, upload.is_validated, candidature.applicant_id, attachment.value as attachment_name, attachment.description, CONCAT(' . $db->quote($site_url . $attachments_folder) . ', candidature.applicant_id, "/", upload.filename) as download_url')
