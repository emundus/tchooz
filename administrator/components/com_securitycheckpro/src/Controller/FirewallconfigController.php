...
class FirewallconfigController extends SecuritycheckproBaseController
{
    ...
    /* Borra IPs de la lista negra din�mica */
    ...
    public function save():void {
        ...
        //El campo 'custom_code' tendr� un formato raw
        ...
        // Establecemos el grupo "Super users" por defecto para aplicar la protecci�n de sesi�n
        ...
        /* Variable que indicar� si los emails introducidos en el campo 'email to' son v�lidos */
        $emails_valid = true;

        /* Chequeamos si los emails introducidos son v�lidos (el campo es opcional) */
	...
	/* Acciones al pulsar el bot�n para exportar las Ips en las listas */
    function export_list(): void
	{
		...
		// Validaci�n b�sica: solo letras, n�meros y guiones bajos.
		...
		try {
			// Selecciona �nicamente la columna que contiene las IPs.
		...
		// Filtramos valores vac�os y duplicados por si acaso.
		...
		// Enviamos cabeceras y contenido (sin usar m�todos obsoletos)
		...
		echo $list;
		// Terminamos la petici�n aqu� para evitar que Joomla agregue HTML extra
		$app->close();
	}  
    ...
    /* Acciones al pulsar el bot�n 'Enable' en la pesta�a url inspector*/
