ALTER TABLE `#__securitycheckpro_dynamic_blacklist` CHANGE `ip` `ip` VARCHAR(255);
ALTER TABLE `#__securitycheckpro_blacklist` CHANGE `ip` `ip` VARCHAR(255);
ALTER TABLE `#__securitycheckpro_whitelist` CHANGE `ip` `ip` VARCHAR(255);
ALTER TABLE `#__securitycheckpro_rules_logs` CHANGE `ip` `ip` VARCHAR(255);
ALTER TABLE `#__securitycheckpro_url_inspector_logs` CHANGE `ip` `ip` VARCHAR(255);
ALTER TABLE `#__securitycheckpro_logs` CHANGE `ip` `ip` VARCHAR(255);
ALTER TABLE `#__securitycheckpro_trackactions` CHANGE `ip_address` `ip_address` VARCHAR(255);
ALTER TABLE `#__securitycheckpro_sessions` CHANGE `ip` `ip` VARCHAR(255);
ALTER TABLE `#__securitycheckpro_users_control` CHANGE `users` `users` TEXT;
ALTER TABLE `#__securitycheckpro` CHANGE `Product` `Product` TEXT;
ALTER TABLE `#__securitycheckpro_vuln_components` CHANGE `Product` `Product` TEXT;
