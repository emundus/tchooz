...
class installerhelper {
	...
	/**
	 * Configuraci�n por defecto del firewall.
	 *
	 * @var array{
	 *   blacklist: string,
	 *   whitelist: string,
    ...
    /* Funci�n que modifica los valores del Firewall web para aplicar una configuraci�n b�sica de los filtros */
    function Set_Easy_Config(): bool
    {
		...
		if (is_array($decoded)) {
			...
			// previous_params ya est� en defaultConfig
			$params = $this->defaultConfig;
		}
			        
        // Par�metros que se desactivan o cuyo valor se deja en blanco para evitar falsos positivos
        ...
        // Codificamos de nuevo los par�metros y los introducimos en la BBDD
        ...
        // Actualizamos el valor del campo que contendr� si se ha aplicado o no esta configuraci�n
		/** @var QueryInterface $query */
		$query = $db->getQuery(true);
		$query->delete($db->quoteName('#__securitycheckpro_storage'));
