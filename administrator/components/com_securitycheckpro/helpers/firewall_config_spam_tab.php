        ...
        <div class="row">
            <div class="col-xl-6 mb-6">
                ...
                <div class="card-body">
                    ...
                    <div class="controls">
						<?php echo booleanlist('detect_arbitrary_strings', array(), $this->detect_arbitrary_strings) ?>
                    </div>
					<blockquote><p class="text-info"><small><?php echo Text::_('COM_SECURITYCHECKPRO_ARBITRARY_STRING_DESCRIPTION') ?></small></p></blockquote>                
				</div>
			</div>
		</div>
    </div>
