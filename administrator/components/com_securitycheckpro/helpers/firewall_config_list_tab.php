            ...
            <div class="row">
                <div class="col-xl-3 mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <blockquote><p class="text-info"><small><?php echo Text::_('PLG_SECURITYCHECKPRO_DYNAMIC_BLACKLIST_DESCRIPTION') ?></small></p></blockquote>
                        <h4 class="card-title"><?php echo Text::_('PLG_SECURITYCHECKPRO_DYNAMIC_BLACKLIST_TIME_LABEL'); ?></h4>
                        <div class="controls">
							<input type="number" class="form-select" size="5" maxlength="5" id="dynamic_blacklist_time" name="dynamic_blacklist_time" value="<?php echo $this->dynamic_blacklist_time ?>" title="" />        
                        </div>
                        <blockquote><p class="text-info"><small><?php echo Text::_('PLG_SECURITYCHECKPRO_DYNAMIC_BLACKLIST_TIME_DESCRIPTION') ?></small></p></blockquote>
						<h4 class="card-title"><?php echo Text::_('PLG_SECURITYCHECKPRO_DYNAMIC_BLACKLIST_COUNTER_LABEL'); ?></h4>
                        <div class="controls">
							<input type="number" class="form-select" size="3" maxlength="3" id="dynamic_blacklist_counter" name="dynamic_blacklist_counter" value="<?php echo $this->dynamic_blacklist_counter ?>" title="" />        
                        </div>
                ...
                <div class="col-xl-3 mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <blockquote><p class="text-info"><small><?php echo Text::_('PLG_SECURITYCHECKPRO_BLACKLIST_EMAIL_LABEL') ?></small></p></blockquote>
					</div>
				<!-- End col -->
                </div>                                            
                <div class="col-xl-3 mb-3">
                    ...
                    <div class="card-body">
                        ...
                        <blockquote><p class="text-info"><small><?php echo Text::_('PLG_SECURITYCHECKPRO_PRIORITY_LABEL') ?></small></p></blockquote>                                                    
                    </div>
				<!-- End col -->
                </div>
			<!-- End row -->
