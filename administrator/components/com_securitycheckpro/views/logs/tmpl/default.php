...
<form action="<?php echo JRoute::_('index.php?option=com_securitycheckpro&view=logs');?>" class="margin-left-10 margin-right-10" method="post" name="adminForm" id="adminForm">
            ...
            <?php echo JHtml::_('grid.sort', 'COM_SECURITYCHECKPRO_LOG_READ', 'marked', $listDirn, $listOrder); ?>                
                                ...
                                if (!empty($this->items) ) {        
                                    ...
                                    <tr>
                                        ...
                                        <?php 
                                        $uri_sanitized =  htmlentities($row->uri);
                                        echo $uri_sanitized;
										?>
