...
<form action="<?php echo JRoute::_('index.php?option=com_securitycheckpro&controller=filemanager&view=filesintegrity&'. JSession::getFormToken() .'=1');?>" method="post" class="margin-left-10 margin-right-10" name="adminForm" id="adminForm">
					...
					<div class="modal-dialog modal-lg" role="document">
						<div class="modal-content">
                            <div class="modal-header alert alert-info">
                                <h2 class="modal-title"><?php echo JText::_('COM_SECURITYCHECKPRO_LAST_SCAN_INFO'); ?></h2>
                            ...
                            <div class="modal-body"> 
								<?php if (!empty($this->last_scan_info)) { ?>
									<div class="margin-left-10">
										<span class="badge badge-info"><b><?php echo JText::_('COM_SECURITYCHECKPRO_MAX_TIME_TO_SCAN_FILE') . '</b>' . htmlspecialchars($this->last_scan_info['max_time']) . " " . JText::_('COM_SECURITYCHECKPRO_SECONDS'); ?></span>
									</div>
									<div class="margin-left-10">
										<span class="badge badge-info margin-bottom-20"><b><?php echo JText::_('COM_SECURITYCHECKPRO_MAX_TIME_FILE') . '</b>' . htmlspecialchars($this->last_scan_info['max_time_filename']); ?></span>
									</div>				
									
									<div class="wrapper">
										<div class="pie-charts">
											<div class="pieID--micro-skills pie-chart--wrapper">
												<h2><?php echo JText::_('COM_SECURITYCHECKPRO_FILES_BY_TYPE'); ?></h2>
												<div class="pie-chart">
													...
													<ul class="pie-chart__legend">
														<li style="border-color: tomato;"><em><?php echo JText::_('COM_SECURITYCHECKPRO_EXECUTABLE_FILES'); ?></em><span>
														<?php 
														...
														?></span></li>
														<li style="border-color: forestgreen;"><em><?php echo JText::_('COM_SECURITYCHECKPRO_NON_EXECUTABLE_FILES'); ?></em><span>
														<?php 
															if ( !empty($this->last_scan_info) ) {
                        ...
                        <div class="row card-body justify-content-center">
                            ...
                            <div <?php echo $list_group_style; ?>>
                                <ul class="list-group text-center">
									...
									?>
										<a href="#last_scan_info_modal" role="button" class="btn btn-secondary btn-sm" data-toggle="modal"><?php echo JText::_('COM_SECURITYCHECKPRO_MORE_INFO'); ?></a>
									<?php
										}
									?>
                                </ul>                                
