                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-3 mb-3">
                                                ...
                                                <div class="card-body">
													...
													<h4 class="card-title"><?php echo JText::_('PLG_SECURITYCHECKPRO_SPAM_PROTECTION_INCLUDE_URLS_LABEL'); ?></h4>
                                                    <div class="controls">
														<textarea cols="35" rows="3" name="include_urls_spam_protection"><?php echo $this->include_urls_spam_protection ?></textarea>
													</div>
                                                    <blockquote class="blockquote" id="block"><footer class="blockquote-footer"><small><?php echo JText::_('PLG_SECURITYCHECKPRO_SPAM_PROTECTION_INCLUDE_URLS_DESCRIPTION') ?></small></footer></blockquote>
											...
											<div class="col-xl-3 mb-3">
                                                <div class="card-header text-white bg-primary">
                                                    <?php echo JText::_('COM_SECURITYCHECKPRO_HONEYPOT_PROTECTION') ?>
                                                </div>
												<div class="card-body">                                                                                                    
													<h4 class="card-title"><?php echo JText::_('COM_SECURITYCHECKPRO_SPAM_PROTECTION_FORMS_LABEL'); ?></h4>
													<div class="controls">
														<textarea cols="35" rows="3" name="forms_to_include_honeypot_in"><?php echo $this->forms_to_include_honeypot_in ?></textarea>
													</div>
													<blockquote class="blockquote" id="block"><footer class="blockquote-footer"><small><?php echo JText::_('COM_SECURITYCHECKPRO_SPAM_PROTECTION_FORMS_LABEL_DESCRIPTION') ?></small></footer></blockquote>
