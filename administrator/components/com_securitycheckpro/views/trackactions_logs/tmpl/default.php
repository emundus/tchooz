...
<form action="<?php echo JRoute::_('index.php?option=com_securitycheckpro&view=trackactions_logs');?>" class="margin-left-10 margin-right-10" method="post" name="adminForm" id="adminForm">
