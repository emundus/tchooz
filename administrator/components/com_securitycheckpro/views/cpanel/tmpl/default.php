...
<form action="<?php echo JRoute::_('index.php?option=com_securitycheckpro');?>" class="margin-left-10 margin-right-10" method="post" name="adminForm" id="adminForm">
    ...
    <div class="row">
        ...
        <?php echo JText::_('COM_SECURITYCHECKPRO_SECURITY_OVERALL_SECURITY_STATUS'); ?>
                ...
                <div class="card-body">
                    <div class="text-align-right">
                        <button id="go_system_info_buton" class="btn btn-info btn-sm right" type="button" href="#"><?php echo JText::_('COM_SECURITYCHECKPRO_CHECK_STATUS'); ?></i></button>
                    </div>                    
        <?php 
        ...
        if ($this->lock_status) { ?>
            ...
            <?php echo(JText::_('COM_SECURITYCHECKPRO_CPANEL_APPLIED')); ?>
                                ...
                                <button id="unlock_tables_button" class="btn btn-info btn-sm right" type="button" href="#"><?php echo JText::_('COM_SECURITYCHECKPRO_UNLOCK_TABLES'); ?></i></button>
        <?php     }else{ ?>
                                    <div class="alert alert-info" role="alert">
            <?php echo(JText::_('COM_SECURITYCHECKPRO_CPANEL_NOT_APPLIED')); ?>
                                    </div>                                    
                                    <button id="lock_tables_button" class="btn btn-info btn-sm right" type="button" href="#"><?php echo JText::_('COM_SECURITYCHECKPRO_LOCK_TABLES'); ?></i></button>
        <?php	}  ?>
                        <a class="btn btn-dark btn-sm left" type="button" href="https://scpdocs.securitycheckextensions.com/dashboard/cpanel/lock-tables-cpanel" target="_blank"  rel="noopener noreferrer"><?php echo JText::_('COM_SECURITYCHECKPRO_MORE_INFO'); ?> <i class="fapro fa-external-link"></i></a>                        
                    </div>                    
                </div>                                
            </div>
