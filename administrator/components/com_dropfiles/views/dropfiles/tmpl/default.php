...
<?php if (DropfilesBase::isJoomla40()) {
    ...
    <div id="pwrapper">
        <div id="wpreview">
            <div class="dropfiles-btn-toolbar" id="dropfiles-toolbar">
                ...
                <div class="btn-wrapper">
                    <button onclick="Joomla.submitbutton('files.checkall')" class="btn btn-small" id="dropfiles-checkall">
                        <span class="icon-checkall"></span>
                        <?php echo JText::_('COM_DROPFILES_CHECKALL'); ?></button>
                </div>
                <div class="btn-wrapper">
    ...
    <div id="rightcol" class="">
        <?php if ($app->input->getBool('caninsert')) : ?>
            <a id="insertcategory" class="btn btn-flat-active ju-button orange-outline-button" href=""
        ...
        <div>
            <div class="categoryblock">
                ...
                <?php if ($app->isClient('administrator') && $this->importFiles && $this->canDo->get('core.admin')) : ?>
                    <div class="well">
