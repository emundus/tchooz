...
$onedrive = $this->form->getFieldset('onedrive_cloud');

if (!$this->form || empty($onedrive)) {
...
<div class="main-container">
    <div class="settings-title">
        <h1 class="settings-header"><?php echo JText::sprintf('COM_DROPFILES_CONFIGURATION_ONE_DRIVE') ?></h1>
    </div>
