...
<div class="main-container">
    <div class="settings-title">
        <h1 class="settings-header"><?php echo JText::sprintf('COM_DROPFILES_CONFIGURATION_FRONTEND_LABEL'); ?></h1>
    </div>
                ...
                <?php if (in_array($k, array('jform_allowedgoogleext', 'jform_usegoogleviewer', 'jform_uri', 'jform_date_format',
                    ...
                    if ($field->type === 'Hidden') :
                        ...
                        <li class="ju-settings-option block-item <?php echo $k; ?>">
                            <label for="<?php echo $field->id; ?>" class="ju-setting-label dropfiles-tooltip"
                                   title="<?php echo JText::sprintf($field->description); ?>">
