...
<?php if ((int) DropfilesBase::loadValue($this->params, 'showsubcategories', 1) || (int) DropfilesBase::loadValue($this->params, 'showcategorytitle', 1)) : ?>
    <script type="text/x-handlebars-template" id="dropfiles-template-default-categories-<?php echo $this->category->id; ?>">
        <div class="dropfiles-categories">
            ...
            <?php if ((int) DropfilesBase::loadValue($this->params, 'showsubcategories', 1)) : ?>
            {{#if categories}}
            {{#each categories}}
            ...
            <ul class="breadcrumbs dropfiles-breadcrumbs-default">
                ...
                <?php if ($this->user_id) : ?>
                    <a data-id="" data-catid="" data-file-type="" class="openlink-manage-files " target="_blank"
                       href="<?php echo $this->urlmanage ?>&task=site_manage&site_catid=<?php echo $this->category->id ?>&template=dropfilesfrontend" data-urlmanage="<?php echo $this->urlmanage ?>">
                                ...
                                <div class="file">
                                    ...
                                    <div class="file-right">
                                        ...
                                        <?php if (isset($file->openpdflink)) { ?>
                                            <a href="<?php echo $file->openpdflink; ?>" class="openlink <?php echo $usegoogleviewer; ?>"
                                                <?php echo $target; ?> >
