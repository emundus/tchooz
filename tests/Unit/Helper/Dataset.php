...
class Dataset
{
	...
	public const FORM_KEYS = [
		...
		'ELEMENT_ORDERLIST' => 'ordered_movies',
	];
		...
		if ($inserted) {
			...
			if (!empty($form_id)) {
				...
				$create_elements = "INSERT INTO jos_fabrik_elements (name, group_id, plugin, label, checked_out, checked_out_time, created, created_by, created_by_alias, modified, modified_by, width, height, `default`, hidden, eval, ordering, show_in_list_summary, filter_type, filter_exact_match, published, link_to_detail, primary_key, auto_increment, access, use_in_page_title, parent_id, params)
                     ...
                     ('ordered_movies', " . $group_id  . ", 'orderlist', 'Ordered List', 0, '0000-00-00 00:00:00', '2023-07-05 10:11:44', 62, 'sysadmin', '2023-07-05 10:14:25', 62, 0, 0, '', 0, 0, 15, 1, '', 1, 1, 0, 0, 0, 1, 0, 0, '{\"show_in_rss_feed\":\"0\",\"bootstrap_class\":\"input-large\",\"show_label_in_rss_feed\":\"0\",\"use_as_rss_enclosure\":\"0\",\"rollover\":\"\",\"tipseval\":\"0\",\"tiplocation\":\"top-left\",\"labelindetails\":\"0\",\"labelinlist\":\"0\",\"comment\":\"\",\"edit_access\":\"1\",\"edit_access_user\":\"\",\"view_access\":\"1\",\"view_access_user\":\"\",\"list_view_access\":\"1\",\"encrypt\":\"0\",\"store_in_db\":\"1\",\"default_on_copy\":\"0\",\"can_order\":\"0\",\"alt_list_heading\":\"\",\"custom_link\":\"\",\"custom_link_target\":\"\",\"custom_link_indetails\":\"1\",\"use_as_row_class\":\"0\",\"include_in_list_query\":\"1\",\"always_render\":\"0\",\"icon_folder\":\"0\",\"icon_hovertext\":\"1\",\"icon_file\":\"\",\"icon_subdir\":\"\",\"filter_length\":\"20\",\"filter_access\":\"1\",\"full_words_only\":\"0\",\"filter_required\":\"0\",\"filter_build_method\":\"0\",\"filter_groupby\":\"text\",\"inc_in_adv_search\":\"1\",\"filter_class\":\"input-medium\",\"filter_responsive_class\":\"\",\"tablecss_header_class\":\"\",\"tablecss_header\":\"\",\"tablecss_cell_class\":\"\",\"tablecss_cell\":\"\",\"sum_on\":\"0\",\"sum_label\":\"Sum\",\"sum_access\":\"1\",\"sum_split\":\"\",\"avg_on\":\"0\",\"avg_label\":\"Average\",\"avg_access\":\"1\",\"avg_round\":\"0\",\"avg_split\":\"\",\"median_on\":\"0\",\"median_label\":\"Median\",\"median_access\":\"1\",\"median_split\":\"\",\"count_on\":\"0\",\"count_label\":\"Count\",\"count_condition\":\"\",\"count_access\":\"1\",\"count_split\":\"\",\"custom_calc_on\":\"0\",\"custom_calc_label\":\"Custom\",\"custom_calc_query\":\"\",\"custom_calc_access\":\"1\",\"custom_calc_split\":\"\",\"custom_calc_php\":\"\",\"validations\":{\"plugin\":[\"notempty\"],\"plugin_published\":[\"1\"],\"validate_in\":[\"both\"],\"validation_on\":[\"both\"],\"validate_hidden\":[\"0\"],\"must_validate\":[\"0\"],\"show_icon\":[\"1\"]},\"alias\":\"\",\"notempty-message\":[],\"notempty-validation_condition\":[],\"sub_options\":{\"sub_values\":[1,2,3],\"sub_labels\":[\"Star Wars\",\"Harry Potter\",\"Le seigneur des anneaux\"],\"sub_initial_selection\":[]},\"options_split_str\":\"\",\"dropdown_populate\":\" \"}')
                ";
				...
				$create_table = "CREATE TABLE `jos_emundus_unit_test_form` (
                  ...
                  `ordered_movies` varchar(255) DEFAULT NULL,
                  PRIMARY KEY (`id`),
	...
	public function insertUnitTestFormData($applicant, $fnum, array $values = [])
	{
		...
		if (!$exists) {
			...
			$columns = ['user', 'fnum', 'e_797_7973', 'e_797_7974', 'e_797_7975', 'e_797_7976', 'e_797_7977', 'e_797_7978', 'e_797_7979', 'e_797_7980', 'e_797_7981', 'e_797_7982', 'e_797_7983', 'dropdown_multi', 'dbjoin_multi', 'cascadingdropdown', 'ordered_movies'];

			if (empty($values)) {
				$values  = array($applicant, $fnum, 'TEST FIELD', 'TEST TEXTAREA', '["1"]', '2', '3', '65', 'Ajoutez du texte personnalisé pour vos candidats', "<p>S'il vous plait taisez vous</p>", '1', '2023-01-01', '2023-07-13 00:00:00', '["0","1"]', 0, '', '"3","2","1"');
			}
