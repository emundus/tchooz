...
<form action="<?php echo hikamarket::completeLink('discount&task=listing'.$this->url_itemid); ?>" method="post" id="adminForm" name="adminForm">
...
foreach($this->discounts as $discount) {
	$url = ($this->manage) ? hikamarket::completeLink('discount&task=show&cid='.$discount->discount_id.$this->url_itemid) : null;
	$extra_classes = '';
...
<form action="<?php echo hikamarket::completeLink('discount&task=delete'.$this->url_itemid); ?>" method="post" name="hikamarket_delete_discount_form" id="hikamarket_delete_discount_form">
	<input type="hidden" name="option" value="<?php echo HIKAMARKET_COMPONENT; ?>" />
