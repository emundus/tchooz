...
?><fieldset>
	<div class="toolbar" id="toolbar" style="float: right;">
		<button class="hikabtn" type="button" onclick="window.hikamarket.submitform('galleryselect','adminForm');"><img style="vertical-align: middle" src="<?php echo HIKASHOP_IMAGES; ?>save.png"/><?php echo JText::_('OK'); ?></button>
	</div>
</fieldset>
<form action="<?php echo hikamarket::completeLink('product&task=galleryimage'.$this->url_itemid, true); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
...
window.hikagallery.select = function(el, id) {
	...
	<div class="clr"></div>
	<input type="hidden" name="product_id" value="<?php echo hikaInput::get()->getInt('product_id'); ?>" />
	...
	<input type="hidden" name="ctrl" value="<?php echo hikaInput::get()->getCmd('ctrl', 'product'); ?>" />
