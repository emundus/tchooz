...
<form action="<?php echo hikamarket::completeLink('product&task=image'.$this->url_itemid); ?>" method="post" name="hikamarket_form" id="hikamarket_form" enctype="multipart/form-data">
