...
?><form action="<?php echo hikamarket::completeLink('product'.$this->url_itemid); ?>" name="hikamarket_translation_form" id="hikamarket_translation_form" method="post" enctype="multipart/form-data">
<?php
