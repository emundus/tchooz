...
otreeCategories.callbackSelection = function(tree,id) {
	...
	if(node.value && node.name) {
		var u = "<?php echo hikamarket::completeLink('product&task=listing&cid=HIKACID'.$this->url_itemid, false, false, true);?>";
...
if(!empty($this->products)) {
	foreach($this->products as $product) {
		$url = ($this->manage) ? hikamarket::completeLink('product&task=edit&cid='.(int)$product->product_id.$this->url_itemid) : hikamarket::completeLink('shop.product&task=show&cid='.(int)$product->product_id);
...
<form action="<?php echo hikamarket::completeLink('product&task=delete'.$this->url_itemid); ?>" method="post" name="hikamarket_delete_product_form" id="hikamarket_delete_product_form">
	<input type="hidden" name="option" value="<?php echo HIKAMARKET_COMPONENT; ?>" />
...
<form action="<?php echo hikamarket::completeLink('product&task=copy'.$this->url_itemid); ?>" method="post" name="hikamarket_copy_product_form" id="hikamarket_copy_product_form">
	<input type="hidden" name="option" value="<?php echo HIKAMARKET_COMPONENT; ?>" />
