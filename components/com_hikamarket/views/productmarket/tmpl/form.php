...
?><?php
$input_classes = 'hk-form-control form-control';
$textarea_classes = '';
...
<form action="<?php echo hikamarket::completeLink('product'.$this->url_itemid);?>" method="post" name="hikamarket_form" id="hikamarket_products_form" enctype="multipart/form-data">
...
<?php if($this->aclEdit('name')) { ?>
			...
			<dd class="hikamarket_product_name"><input type="text" class="<?php echo $input_classes; ?>" name="data[product][product_name]" value="<?php echo $this->escape(@$this->product->product_name); ?>"/></dd>
<?php } else { ?>
			<dt class="hikamarket_product_name"><label><?php echo JText::_('HIKA_NAME'); ?></label></dt>
...
<?php }
	...
	if($this->aclEdit('code')) { ?>
			...
			<dd class="hikamarket_product_code"><input type="text" class="<?php echo $input_classes; ?>" name="data[product][product_code]" value="<?php echo $this->escape(@$this->product->product_code); ?>"/></dd>
<?php }
...
?>
				...
				<dd class="hikamarket_product_msrp">
					<input type="text" class="<?php echo $input_classes; ?>" name="data[product][product_msrp]" value="<?php echo $this->escape(@$this->product->product_msrp); ?>"/> <?php echo $mainCurr[$this->main_currency_id]->currency_symbol.' '.$mainCurr[$this->main_currency_id]->currency_code;?>
				</dd>
<?php
			}
?>
...
<?php
		if($this->aclEdit('pagetitle')) { ?>
				...
				<dd class="hikamarket_product_pagetitle"><input type="text" class="<?php echo $input_classes; ?> fullrow" size="45" name="data[product][product_page_title]" value="<?php echo $this->escape(@$this->product->product_page_title); ?>" /></dd>
<?php
		}

		if($this->aclEdit('url')) { ?>
				<dt class="hikamarket_product_url"><label><?php echo JText::_('URL'); ?></label></dt>
				<dd class="hikamarket_product_url"><input type="text" class="<?php echo $input_classes; ?> fullrow" size="45" name="data[product][product_url]" value="<?php echo $this->escape(@$this->product->product_url); ?>" /></dd>
<?php
		}
		...
		if($this->aclEdit('metadescription')) { ?>
				...
				<dd class="hikamarket_product_metadescription"><textarea id="product_meta_description" class="<?php echo $textarea_classes; ?> fullrow" cols="35" rows="2" name="data[product][product_meta_description]"><?php echo $this->escape(@$this->product->product_meta_description); ?></textarea></dd>
<?php
		}

		if($this->aclEdit('keywords')) { ?>
				<dt class="hikamarket_product_keywords"><label><?php echo JText::_('PRODUCT_KEYWORDS'); ?></label></dt>
				<dd class="hikamarket_product_keywords"><textarea id="product_keywords" class="<?php echo $textarea_classes; ?> fullrow" cols="35" rows="2" name="data[product][product_keywords]"><?php echo $this->escape(@$this->product->product_keywords); ?></textarea></dd>
<?php
		}

		if($this->aclEdit('alias')) { ?>
				<dt class="hikamarket_product_alias"><label><?php echo JText::_('HIKA_ALIAS'); ?></label></dt>
				<dd class="hikamarket_product_alias"><input type="text" class="<?php echo $input_classes; ?> fullrow" size="45" name="data[product][product_alias]" value="<?php echo $this->escape(@$this->product->product_alias); ?>" /></dd>
<?php
		}

		if($this->aclEdit('canonical')) { ?>
				<dt class="hikamarket_product_canonical"><label><?php echo JText::_('PRODUCT_CANONICAL'); ?></label></dt>
				<dd class="hikamarket_product_canonical"><input type="text" class="<?php echo $input_classes; ?> fullrow" size="45" name="data[product][product_canonical]" value="<?php echo $this->escape(@$this->product->product_canonical); ?>"/></dd>
<?php
		}
...
<?php
	if($this->aclEdit('qtyperorder')) {?>
				...
				<dd class="hikamarket_product_qtyperorder">
					<input type="text" class="<?php echo $input_classes; ?> hk-form-inline" name="data[product][product_min_per_order]" value="<?php echo (int)@$this->product->product_min_per_order; ?>" /><?php
...
<?php }
	...
	if($this->aclEdit('weight')) { ?>
				...
				<dd class="hikamarket_product_weight"><input type="text" class="<?php echo $input_classes; ?> hk-form-inline" name="data[product][product_weight]" value="<?php echo $this->escape(@$this->product->product_weight); ?>"/><?php echo $this->weight->display('data[product][product_weight_unit]', @$this->product->product_weight_unit); ?></dd>
<?php }
