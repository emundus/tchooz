...
if(HIKASHOP_J40 && method_exists($doc, 'getScriptOptions')) {
	echo "\r\n".'<script type="application/json" class="joomla-script-options new">'.
		json_encode($doc->getScriptOptions()).
		'</script>';
?>
<script type="text/javascript">
try {
	Joomla.loadOptions();
	document.getElementById('hikamarket_product_variant_edition_<?php echo $this->product->product_id; ?>').dispatchEvent(new CustomEvent('joomla:updated', {
		bubbles: true,
		cancelable: true,
	}));
} catch(e) {}
