...
<table id="hikamarket_order_history_listing" class="hikam_listing table table-striped table-hover table-bordered">
	<thead>
		<tr>
			<th class="title"><?php
...
<?php if($acl_history_data) { ?>
			<td>
				<a onclick="return window.orderMgr.showHistory(this);" data-popup-href="<?php echo hikamarket::completeLink('order&task=history&order_id='.$this->order->order_id.'&cid='.$history->history_id.$this->url_itemid, true); ?>" href="#"><i class="fas fa-info-circle"></i></a>
			</td>
<?php } ?>
		</tr>
<?php
