...
?>
	...
	<table class="hikam_listing table table-striped table-hover table-bordered" id="hikamarket_order_subsales" style="width:100%">
		<thead>
			<tr>
...
?>
					<a href="<?php echo hikamarket::completeLink('order&task=show&cid='.(int)$subOrder->order_id.$this->url_itemid);?>"><?php echo $subOrder->order_number; ?></a>
<?php
		} else {
