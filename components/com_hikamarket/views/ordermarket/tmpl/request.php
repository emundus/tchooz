...
?><form action="<?php echo hikamarket::completeLink('order'.$this->url_itemid); ?>" method="post" id="hikamarket_order_request_form" name="hikamarket_order_request_form">
<?php
...
?>
	<table class="hikam_listing table table-striped table-hover table-bordered" style="width:100%">
		<thead>
			<tr>
