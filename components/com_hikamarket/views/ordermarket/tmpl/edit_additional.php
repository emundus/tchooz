...
?><form action="<?php echo hikamarket::completeLink('order&task=save&subtask=additional&tmpl=component'.$this->url_itemid); ?>" name="hikamarket_order_additional_form" id="hikamarket_order_additional_form" method="post" enctype="multipart/form-data">
