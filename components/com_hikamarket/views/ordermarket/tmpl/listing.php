...
?>		<td style="width:<?php echo $width;?>%" class="<?php echo $class; ?>">
			<a href="<?php echo hikamarket::completeLink('order&task=listing&filter_status='.$status.$this->url_itemid); ?>">
...
?>
		<td style="width:<?php echo $width;?>%">
			<a href="<?php echo hikamarket::completeLink('order&task=listing&filter_status='.$this->url_itemid); ?>">
