...
<form action="<?php echo hikamarket::completeLink('category&task=galleryimage'.$this->url_itemid, true); ?>" method="post" name="adminForm" id="adminForm" enctype="multipart/form-data">
