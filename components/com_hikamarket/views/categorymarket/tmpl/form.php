...
<form action="<?php echo hikamarket::completeLink('category'.$this->url_itemid);?>" method="post" name="hikamarket_form" id="hikamarket_categories_form" enctype="multipart/form-data">
