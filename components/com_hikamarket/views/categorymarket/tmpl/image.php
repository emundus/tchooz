...
<form action="<?php echo hikamarket::completeLink('category&task=image'.$this->url_itemid); ?>" method="post" name="hikamarket_form" id="hikamarket_form" enctype="multipart/form-data">
	<table width="100%">
		<tr>
			<td class="key">
