...
class vendormarketViewvendormarket extends HikamarketView {
	...
	public function show() {
		...
		$pathway->addItem($vendor->vendor_name, hikamarket::completeLink('vendor&task=show&cid='.(int)$vendor->vendor_id.'&name='.$vendor->alias.$this->url_itemid));
	...
	public function cpanel() {
		...
		$buttons = array(
			'account' => array(
				'url' => hikamarket::completeLink('vendor&task=form'.$this->url_itemid),
				'level' => 0,
			...
			'category' => array(
				'url' => hikamarket::completeLink('category'.$this->url_itemid),
				'level' => 0,
			...
			'characteristic' => array(
				'url' => hikamarket::completeLink('characteristic'.$this->url_itemid),
				'level' => 0,
			...
			'discount' => array(
				'url' => hikamarket::completeLink('discount'.$this->url_itemid),
				'level' => 0,
			...
			'shipping' => array(
				'url' => hikamarket::completeLink('plugin&plugin_type=shipping'.$this->url_itemid),
				'level' => 0,
			...
			'payment' => array(
				'url' => hikamarket::completeLink('plugin&plugin_type=payment'.$this->url_itemid),
				'level' => 0,
	...
	public function listing() {
		...
		$marketDefaultParams['div_item_layout_type'] = $config->get('div_item_layout_type', 'img_title');
