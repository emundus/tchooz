...
<?php } ?>
<form action="<?php echo hikamarket::completeLink('vendor'.$this->url_itemid); ?>" method="post" name="adminForm" id="adminForm">
	...
	<table class="hikam_listing table table-striped table-hover" style="cell-spacing:1px">
		<thead>
			<tr>
