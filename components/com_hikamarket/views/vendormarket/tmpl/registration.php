...
<?php
$input_classes = HK_FORM_CONTROL_CLASS;
$textarea_classes = '';
...
?>
	...
	<dd class="hikamarket_registration_name_line">
		<input type="text" id="register_name" name="data[register][name]" value="<?php echo $this->escape($user_name); ?>" class="<?php echo $input_classes; ?> required" maxlength="50"/>
	</dd>
<?php if($this->config->get('registration_email_is_username', 0) == 0) { ?>
	...
	<dd class="hikamarket_registration_username_line">
		<input type="text" id="register_username" name="data[register][username]" value="<?php echo $this->escape($user_username); ?>" class="<?php echo $input_classes; ?> required validate-username" maxlength="25"/>
	</dd>
<?php } ?>
	...
	<dd class="hikamarket_registration_email_line">
		<input type="text" id="register_email" name="data[register][email]" value="<?php echo $this->escape($user_email); ?>" class="<?php echo $input_classes; ?> required validate-email" maxlength="100"/>
	</dd>
...
<?php if($this->config->get('registration_ask_password', 1) == 1) { ?>
	...
	<dd class="hikamarket_registration_password_line">
		<input type="password" id="register_password" name="data[register][password]" value="" class="<?php echo $input_classes; ?> required validate-password"/>
	</dd>
	...
	<dd class="hikamarket_registration_password2_line">
		<input type="password" id="register_password2" name="data[register][password2]" value="" class="<?php echo $input_classes; ?> required validate-passverify"/>
	</dd>
<?php } ?>
...
<dl id="hikamarket_<?php echo 'user_'.$oneExtraField->field_namekey; ?>" class="hikam_options hikamarket_registration_user_<?php echo $fieldName;?>_line">
	...
	<dd><?php
		...
		echo $this->fieldsClass->display(
			...
			'data[user]['.$fieldName.']',
			false,
			' class="'.$input_classes.'" '.$onWhat.'="hikashopToggleFields(this.value,\''.$fieldName.'\',\'user\',0,\'hikamarket_registration_\');"',
			false,
...
<dl id="hikamarket_<?php echo 'address_'.$oneExtraField->field_namekey; ?>" class="hikam_options hikamarket_registration_address_<?php echo $fieldName;?>_line">
	...
	<dd><?php
		...
		echo $this->fieldsClass->display(
			...
			false,
			' class="'.$input_classes.'" '.$onWhat.'="hikashopToggleFields(this.value,\''.$fieldName.'\',\'address\',0,\'hikamarket_registration_\');"',
			false,
...
?>
	...
	<dd class="hikamarket_<?php echo $this->form_type; ?>_vendorname_line">
		<input type="text" id="<?php echo $this->form_type; ?>_vendorname" name="data[<?php echo $this->form_type; ?>][vendor_name]" value="<?php echo $this->escape($this->element->vendor_name); ?>" class="<?php echo $input_classes; ?> required" maxlength="50"/>
	</dd>
<?php if(!empty($this->user->user_id) || $this->form_type != 'vendorregister') { ?>
	...
	<dd class="hikamarket_<?php echo $this->form_type; ?>_email_line">
		<input type="text" id="<?php echo $this->form_type; ?>_vendoremail" name="data[<?php echo $this->form_type; ?>][vendor_email]" value="<?php echo $this->escape($this->element->vendor_email); ?>" class="<?php echo $input_classes; ?> required validate-email" maxlength="50"/>
	</dd>
<?php }
...
?>
	...
	<dd class="hikamarket_<?php echo $this->form_type; ?>_paypal_line">
		<input type="text" id="<?php echo $this->form_type; ?>_paypal_email" name="data[<?php echo $this->form_type; ?>][vendor_params][paypal_email]" value="<?php echo $this->escape(@$this->element->vendor_params->paypal_email); ?>" class="<?php echo $input_classes; ?> <?php echo $r?'required':'';?> validate-email" maxlength="50"/><?php echo $r?' *':'';?>
	</dd>
<?php
	}
...
<dl id="hikamarket_vendor_<?php echo $oneExtraField->field_namekey; ?>" class="hikam_options hikamarket_<?php echo $this->form_type; ?>_<?php echo $fieldName;?>_line">
	...
	<dd><?php
			...
			echo $this->fieldsClass->display(
				...
				false,
				' class="'.$input_classes.'" ' . $onWhat . '="hikashopToggleFields(this.value,\''.$fieldName.'\',\'vendor\',0,\'hikamarket_\');"',
				false,
