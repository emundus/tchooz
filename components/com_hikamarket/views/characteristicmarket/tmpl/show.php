...
<form action="<?php echo hikamarket::completeLink('characteristic'.$this->url_itemid);?>" method="post" name="adminForm" id="adminForm">
...
?>
	<div class="hk-row-fluid">
		...
		<div class="hkc-4">
			<div class="expand-filters" style="width:auto;float:right"><?php
