...
?><div>
<form action="<?php echo hikamarket::completeLink('characteristic&task=listing'.$this->url_itemid); ?>" method="post" id="adminForm" name="adminForm">
...
foreach($this->characteristics as $characteristic) {
	...
	if($this->manage)
		$url = hikamarket::completeLink('characteristic&task=show&cid='.$characteristic->characteristic_id.$this->url_itemid);
?>
