...
?><form action="<?php echo hikamarket::completeLink('user'.$this->url_itemid);?>" method="post" name="hikamarket_form" id="hikamarket_user_form">
	...
	<table class="hikam_listing hikam_table hikam_bordered" style="width:100%">
		...
		<tfoot>
			<tr>
				...
				?> <a href="<?php echo hikamarket::completeLink('order&task=listing&filter_user='.$this->user->user_id.$this->url_itemid); ?>"><?php echo JText::_('HIKAM_SEE_MORE'); ?></a></th>
			</tr>
		</tfoot>
<?php
$k = 0;
...
<?php if($order_show) { ?>
					<a href="<?php echo hikamarket::completeLink('order&task=show&cid='.$order->order_id.$this->url_itemid); ?>"><?php
	}
