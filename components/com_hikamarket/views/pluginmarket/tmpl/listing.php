...
<form action="<?php echo hikamarket::completeLink('plugin&task=delete'.$this->url_itemid); ?>" method="post" name="hikamarket_delete_plugin_form" id="hikamarket_delete_plugin_form">
	<input type="hidden" name="option" value="<?php echo HIKAMARKET_COMPONENT; ?>" />
