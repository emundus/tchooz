...
?><form action="<?php echo hikamarket::completeLink('plugin&task=add&plugin_type='.$this->plugin_type.$this->url_itemid); ?>" method="post" name="hikamarket_form" id="hikamarket_form">
...
?>
		<tr class="row<?php echo $k; ?>">
			...
			?></td>
			<td>
				<a href="<?php echo hikamarket::completeLink('plugin&task=edit&name='.$row->element.'&plugin_type='.$this->plugin_type.'&subtask=edit'.$this->url_itemid);?>"><?php
