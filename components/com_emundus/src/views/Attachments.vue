                ...
                <table :class="{ loading: loading }" aria-describedby="Table of attachments information">
                    <thead>
                        <tr>
                            ...
                            <th
                                v-if="columns.includes('desc')"
                                id="desc"
                                class="desc"
                                @click="orderBy('upload_description')"
                            >
                            ...
                            <th
                                v-if="columns.includes('category')"
                                id="category"
                                class="category"
                            ...
                            <th
                                v-if="canSee && columns.includes('modified_by')"
                                id="modified_by"
                                @click="orderBy('modified_by')"
                            >
                            ...
                            <th
                                v-if="columns.includes('modified')"
                                id="modified"
                                class="date"
                                @click="orderBy('modified')"
                            >
