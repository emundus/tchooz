					...
					tabs: [
						{
							...
							actions: [
								...
								{
									action: 'updatecontactfiles',
									label: 'COM_EMUNDUS_ONBOARD_UPDATE_CONTACT_FILES',
									type: 'modal',
									component: 'UpdateContactFiles',
							...
							imports: [
								{
									...
									label: 'COM_EMUNDUS_ONBOARD_ACTION_IMPORT_CONTACTS',
									type: 'modal',
						...
						},
						{
							...
							actions: [
								...
								{
									action: 'updateorganizationfiles',
									label: 'COM_EMUNDUS_ONBOARD_UPDATE_ORGANIZATION_FILES',
									type: 'modal',
									component: 'UpdateOrganizationFiles',
							...
							imports: [
								{
									...
									label: 'COM_EMUNDUS_ONBOARD_ACTION_IMPORT_ORGANIZATIONS',
									type: 'modal',
									component: 'ImportEntity',
									name: 'import',
									acl: 'organization|c',
