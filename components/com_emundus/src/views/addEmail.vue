			...
			<form @submit.prevent="submit" class="fabrikForm emundus-form">
				<div>
					...
					<div class="tw-flex tw-flex-col tw-gap-4">
						...
						<div>
							<label class="tw-font-medium"
								>{{ translate('COM_EMUNDUS_ONBOARD_ADDEMAIL_BODY') }} <span class="tw-text-red-600">*</span></label
							>
							<tip-tap-editor
								v-if="editor_ready"
		...
		getEmailById() {
			emailService
				...
				.then((resp) => {
					...
					if (resp.data.receivers !== null && resp.data.receivers !== undefined && resp.data.receivers !== '') {
