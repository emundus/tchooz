  ...
  <div>
    ...
    <div id="messenger_notifications_popup">
      ...
      <div class="tw-relative" style="height: 20px" id="messenger_notifications_icon">
        <span class="material-symbols-outlined tw-cursor-pointer tw-text-neutral-900" @click="modalOpened = !modalOpened">question_answer</span>
        <div class="tw-absolute tw-bg-red-500 tw-rounded-full" style="top: -2px;right: 4px;width: 8px;height: 8px" v-if="notifications.length > 0"></div>
      </div>
    </div>
  </div>
</template>
