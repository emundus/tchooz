export default [
	...
	},
	{
		displayed: true,
		component: 'joomla',
		label: 'COM_EMUNDUS_ONBOARD_SETTINGS_GENERAL_OFFLINE',
		helptext: 'COM_EMUNDUS_ONBOARD_SETTINGS_GENERAL_OFFLINE_DESC',
		param: 'offline',
		type: 'yesno',
		placeholder: '',
		optional: 1,
	},
	{
		displayed: true,
		component: 'joomla',
		label: 'COM_EMUNDUS_ONBOARD_SETTINGS_GENERAL_OFFLINE_MESSAGE',
		param: 'offline_message',
		type: 'textarea',
		maxlength: 255,
		placeholder: '',
		optional: 1,
		displayedOn: 'offline',
		displayedOnValue: 1,
		default: 'La plateforme est actuellement en maintenance. Merci de revenir plus tard.',
	},
];
