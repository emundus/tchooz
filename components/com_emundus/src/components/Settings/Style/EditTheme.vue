<template>
  <div>
    <div class="tw-flex tw-items-center tw-gap-2" v-if="primary && secondary">
      ...
      <div
          class="tw-w-32 tw-rounded-md tw-p-3 tw-cursor-help"
          :class="contrastRatio > 3.1 && rgaaState === 1 ? 'tw-bg-main-50' : 'tw-bg-red-50'"
      >
        <div class="tw-flex tw-items-center tw-justify-between" :class="rgaaState === 1 ? 'tw-text-green-500' : 'tw-text-red-500'">
          <label class="tw-text-xs !tw-mb-0 tw-cursor-help">RGAA</label>
          <span class="material-icons-outlined tw-text-green-500 !tw-text-sm" v-if="rgaaState === 1">check_circle</span>
          <span class="material-icons-outlined tw-text-red-500" v-else>report_problem</span>
        </div>

        <div class="tw-flex tw-items-start tw-justify-between" :class="contrastRatio > 3.1 ? 'tw-text-green-500' : 'tw-text-red-500'">
