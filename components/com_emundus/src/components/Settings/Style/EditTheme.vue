						...
						<div>
							...
							<div class="tw-mt-1 tw-flex tw-items-center tw-gap-2">
								<span class="material-symbols-outlined tw-text-green-500" v-if="contrastPrimary.AA === 'pass'"
									>check_circle</span
								>
								<span class="material-symbols-outlined tw-text-red-600" v-if="contrastPrimary.AA === 'fail'"
									>highlight_off</span
								>
								<button
							...
							<div class="tw-mt-1 tw-flex tw-items-center tw-gap-2">
								<span class="material-symbols-outlined tw-text-green-500" v-if="contrastSecondary.AA === 'pass'"
									>check_circle</span
								>
								<span class="material-symbols-outlined tw-text-red-600" v-if="contrastSecondary.AA === 'fail'"
									>highlight_off</span
								>
								<button
						...
						<div class="tw-mt-3">
							...
							<div class="tw-mt-1 tw-flex tw-items-center tw-gap-2">
								<span class="material-symbols-outlined tw-text-green-500" v-if="contrastPrimary.AALarge === 'pass'"
									>check_circle</span
								>
								<span class="material-symbols-outlined tw-text-red-600" v-if="contrastPrimary.AALarge === 'fail'"
									>highlight_off</span
								>
								<button
							...
							<div class="tw-mt-1 tw-flex tw-items-center tw-gap-2">
								<span class="material-symbols-outlined tw-text-green-500" v-if="contrastSecondary.AALarge === 'pass'"
									>check_circle</span
								>
								<span class="material-symbols-outlined tw-text-red-600" v-if="contrastSecondary.AALarge === 'fail'"
									>highlight_off</span
								>
								<button
