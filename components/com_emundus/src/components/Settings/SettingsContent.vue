				...
				<div class="tw-flex-col tw-flex">
					<div class="tw-flex tw-items-center tw-justify-between tw-p-5">
						<h2 id="accordion-collapse-heading-1" class="tw-user-select-none tw-flex tw-justify-between">
							<span :id="'Subtile' + indexSection" class="tw-text-2xl tw-user-select-none">{{
						...
						<span
							class="material-symbols-outlined tw-scale-150 tw-user-select-none hidden"
					...
					<span v-if="section.intro" class="tw-text-sm tw-text-neutral-800 tw--mt-5 tw-pb-5 tw-px-5">{{
