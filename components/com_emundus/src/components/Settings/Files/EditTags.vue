<template>
	<div class="tw-flex tw-flex-wrap tw-justify-start">
		<div class="tw-w-10/12">
			...
			<draggable handle=".handle" v-model="tags" :class="'draggables-list'" @end="updateTagOrdering">
				<div
...
export default {
	...
	methods: {
		...
		manageKeyup(tag) {
			document.getElementById('tag_label_' + tag.id).textContent = document
				.getElementById('tag_label_' + tag.id)
				.textContent.trim();
