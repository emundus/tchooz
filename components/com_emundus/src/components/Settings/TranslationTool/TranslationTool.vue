		...
		>
			...
			<div class="em-modal-content">
				...
				<transition name="fade">
					<Global
						v-if="currentMenu === 1"
						v-show="!setup_success"
						class="em-modal-component"
						@updateOrphelinsCount="updateOrphelinsCount"
					></Global>
					<Translations
				...
				<img
					v-if="setup_success"
					alt="checked-animation"
					class="em-success-animation"
			...
			<div v-if="loading">
				...
				<p class="em-page-loader-text" v-if="!setup_success">
					{{ translate('COM_EMUNDUS_ONBOARD_TRANSLATION_TOOL_SETUP_PROGRESSING') }}
				</p>
				<p class="em-page-loader-text em-fade-loader" v-if="setup_success">
					{{ translate('COM_EMUNDUS_ONBOARD_TRANSLATION_TOOL_SETUP_SUCCESS') }}
				</p>
			</div>
		</modal>
	</span>
