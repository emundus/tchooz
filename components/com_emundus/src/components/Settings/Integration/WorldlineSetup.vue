	...
	data() {
		return {
			...
			authFields: [
				{
					...
					type: 'toggle',
					value: 0,
					label: 'COM_EMUNDUS_SETTINGS_INTEGRATION_WORLDLINE_PRODUCTION_MODE',
					helptext: 'COM_EMUNDUS_SETTINGS_INTEGRATION_WORLDLINE_PRODUCTION_MODE_HELP',
					displayed: true,
				...
				},
				{
					...
					placeholder: '',
					value: '',
					label: 'COM_EMUNDUS_SETTINGS_INTEGRATION_WORLDLINE_SETUP_MERCHANT_ID',
					helptext: '',
					displayed: true,
					configEntry: 'authentication',
				},
				{
					...
					placeholder: '',
					value: '',
					label: 'COM_EMUNDUS_SETTINGS_INTEGRATION_WORLDLINE_SETUP_API_KEY_ID',
					helptext: '',
					displayed: true,
					configEntry: 'authentication',
				},
				{
					...
					placeholder: '',
					value: '',
					label: 'COM_EMUNDUS_SETTINGS_INTEGRATION_WORLDLINE_SETUP_API_SECRET',
					helptext: '',
					displayed: true,
					configEntry: 'authentication',
				},
				{
					param: 'checkout_subdomain',
					type: 'text',
					placeholder: 'payment',
					value: '',
			...
			tabs: [
				{
					id: 'auth',
					name: 'COM_EMUNDUS_SETTINGS_INTEGRATION_WORLDLINE_SETUP_AUTH',
					active: true,
					displayed: true,
				},
			],
...
<template>
	...
	>
		...
		<h3>{{ translate('COM_EMUNDUS_WORLDLINE_SETUP_TITLE') }}</h3>
		...
		<div v-if="selectedTab === 'auth'" class="tw-flex tw-flex-col tw-gap-4">
			...
			<div class="tw-flex tw-flex-col tw-gap-2">
				<label class="tw-mb-0 tw-flex tw-items-end tw-font-medium" for="webhook-endpoint-url"
					>{{ translate('COM_EMUNDUS_WORLDLINE_SETUP_WEBHOOK_ENDPOINT_LABEL') }}
				</label>
				<span class="tw-text-base tw-text-neutral-600"
					>{{ translate('COM_EMUNDUS_WORLDLINE_SETUP_WEBHOOK_ENDPOINT_LABEL_HELP') }}
				</span>
		...
		<div class="tw-flex tw-justify-end">
			<button class="tw-btn-primary" @click="setupWorldline">
				{{ translate('SAVE') }}
			</button>
		</div>
	</div>
