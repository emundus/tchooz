	...
	<span :id="'modalImportDatas'">
		...
		>
			...
			<div class="modalC-content">
				...
				<vue-csv-import
					v-model="csv"
					:map-fields="form.db_columns"
					:key="csv_comp"
					tableSelectClass="dropdown-toggle"
					tableClass="custom-table-csv"
					v-if="importCSV"
					ref="csvimport"
				>
					...
					<template slot="next" slot-scope="{ load }">
						<button class="bouton-sauvergarder-et-continuer" style="float: left" @click.prevent="load">
							{{ translations.Load }}
						</button>
					</template>
			...
			<div class="mb-1 tw-flex tw-items-center tw-justify-between">
