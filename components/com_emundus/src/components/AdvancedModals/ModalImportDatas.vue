     ...
     <div class="modalC-content">
        <div v-if="!importCSV">
            ...
            <div class="form-group">
              ...
              <textarea v-model="form.desc" maxlength="150" class="form__input field-general w-input"
                        style="margin: 0"/>
            </div>
            ...
            <div class="col-md-12">
              <div v-for="(sub_values, i) in form.db_columns" :key="i" class="dpflex">
                <input type="text" v-model="form.db_columns[i]" class="form__input field-general w-input db-values"
                       :id="'columns_' + i" @keyup.enter="add"/>
          ...
          <vue-csv-import v-model="csv" :map-fields="form.db_columns" :key="csv_comp" tableSelectClass="dropdown-toggle"
                          tableClass="custom-table-csv" v-if="importCSV" ref="csvimport">
              ...
              <template slot="next" slot-scope="{load}">
                  <button class="bouton-sauvergarder-et-continuer" style="float: left"
                          @click.prevent="load">{{ translations.Load }}</button>
              </template>
