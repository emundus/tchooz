...
<template>
  <div class="tw-flex tw-gap-2 tw-items-start">
    <input v-if="canBeSelected" v-model="calendarEvent.show"
           type="checkbox"
           class="tw-cursor-pointer event-checkbox tw-appearance-none tw-w-[20px] !tw-h-[20px] tw-rounded-md tw-relative"
           :style="calendarStyle"
    />
    <div v-else class="tw-min-w-[20px] tw-min-h-[20px] tw-rounded-md"
  ...
  <div class="tw-flex tw-items-center tw-gap-2">
    ...
    <p class="tw-overflow-hidden tw-text-ellipsis tw-whitespace-nowrap">{{ translate('COM_EMUNDUS_ONBOARD_ADD_EVENT_BOOKED_SLOT_NUMBER') }}</p>
  </div>
</template>
