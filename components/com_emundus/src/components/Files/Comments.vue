<template>
  <div id="comments" class="tw-p-4 tw-w-full tw-bg-[#f8f8f8] tw-border-l-4 tw-border-profile-full tw-flex tw-flex-col">
            ...
            <div class="file-comment-header-left tw-flex tw-flex-row tw-cursor-pointer tw-items-center tw-justify-between tw-w-full"
              ...
              <div class="tw-flex tw-flex-row tw-items-center">
                <div class="profile-picture tw-h-8 tw-w-8 tw-rounded-full tw-border-2 tw-mr-2 tw-flex tw-flex-row tw-justify-center tw-items-center" :class="{'tw-bg-neutral-300' : !comment.profile_picture}">
                  <div v-if="comment.profile_picture" class="image tw-h-full tw-w-full tw-rounded-full" :style="'background-image: url(' + comment.profile_picture + ');background-size: cover;background-position: center;'"></div>
                  <span v-else class="tw-text-sm">{{ comment.firstname.charAt(0).toUpperCase() }}{{ comment.lastname.charAt(0).toUpperCase() }}</span>
                </div>
            ...
            <div class="child-comment tw-flex tw-flex-col tw-border-s-4 tw-my-3 tw-px-3">
              <div class="file-comment-header tw-flex tw-flex-row tw-justify-between tw-mb-2">
                <div class="file-comment-header-left tw-flex tw-flex-col">
                  <div class="tw-flex tw-flex-row tw-items-center">
                    <div class="profile-picture tw-h-8 tw-w-8 tw-rounded-full tw-border-2 tw-mr-2 tw-flex tw-flex-row tw-justify-center tw-items-center">
                      <div v-if="comment.profile_picture" class="image tw-h-full tw-w-full tw-rounded-full" :style="'background-image: url(' + comment.profile_picture + '); background-size: cover;background-position: center;'"></div>
    ...
    <modal :name="'add-comment-modal'"
           height="30em"
           width="30em"
           transition="fade"
           :delay="100" :clickToClose="false" ref="modal">
