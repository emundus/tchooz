<template>
  <div id="form-builder-rules-js-conditions" class="tw-self-start tw-w-full">
    ...
    <button type="button" @click="$emit('add-condition',index)" class="em-tertiary-button tw-mt-2 tw-w-auto tw-float-right">{{ translate('COM_EMUNDUS_ONBOARD_PARAMS_ADD_REPEATABLE_CONDITION') }}</button>
  </div>
</template>
