...
import FormBuilderRulesJsConditions from '@/components/FormBuilder/FormBuilderRules/FormBuilderRulesType/FormBuilderRulesJsConditions.vue';
import FormBuilderRulesJsAction from '@/components/FormBuilder/FormBuilderRules/FormBuilderRulesType/FormBuilderRulesJsAction.vue';
...
export default {
	...
	computed: {
		titleLabel() {
			return this.rule
				? this.translate('COM_EMUNDUS_FORM_BUILDER_RULE_EDIT_JS')
				: this.translate('COM_EMUNDUS_FORM_BUILDER_RULE_ADD_JS');
		},
	},
};
</script>
