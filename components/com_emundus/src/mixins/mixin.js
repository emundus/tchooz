		...
		formattedDate: function (date = '', format = 'LLLL', utc = null) {
			...
			if (date !== null) {
				...
				if (date !== '') {
					...
					formattedDate =
						utc != null && typeof utc != 'undefined'
							? moment(stringDate).utcOffset(utc).format(format)
							: moment(stringDate).format(format);
				} else {
					formattedDate =
						utc != null && typeof utc != 'undefined' ? moment().utcOffset(utc).format(format) : moment().format(format);
				}
			}
