...
* Full name: `\Joomla\CMS\MVC\View\AbstractView`
* This class implements:
[`\Joomla\CMS\MVC\View\ViewInterface`](./ViewInterface.md), [`\Joomla\Event\DispatcherAwareInterface`](../../../Event/DispatcherAwareInterface.md), [`\Joomla\CMS\Document\DocumentAwareInterface`](../../Document/DocumentAwareInterface.md), [`\Joomla\CMS\Language\LanguageAwareInterface`](../../Language/LanguageAwareInterface.md)
...
```php
public \Joomla\CMS\Document\Document $document
```
