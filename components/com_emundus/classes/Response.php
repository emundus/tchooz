...
class Response implements \JsonSerializable
{
	...
	{
		return new self(false, $msg, $code, $data, $description);
	}

	public static function processing(string $msg = '', int $code = 102, mixed $data = []): self
	{
		return new self(false, $msg, $code, $data);
	}
