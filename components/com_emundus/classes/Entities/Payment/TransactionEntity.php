...
class TransactionEntity
{
	...
	/**
	 * @var string The reference shared with the payment service provider, generated by eMundus
	 */
	private string $external_reference = '';

	/**
	 * @var ExternalReferenceEntity[] Every reference pointing to this transaction, the main one included
	 */
	private array $external_references = [];
	...
	/**
	 * @param   ExternalReferenceEntity[]  $external_references
	 */
	public function setExternalReferences(array $external_references): void
	{
		foreach ($external_references as $external_reference) {
			if (!$external_reference instanceof ExternalReferenceEntity) {
				throw new \InvalidArgumentException('External references must be instances of ' . ExternalReferenceEntity::class);
			}
		}

		$this->external_references = array_values($external_references);
	}

	/**
	 * @return ExternalReferenceEntity[]
	 */
	...
	public function serialize(): array
	{
		return [
			...
			'external_references' => array_map(static function (ExternalReferenceEntity $external_reference) {
				return $external_reference->serialize();
			}, $this->getExternalReferences()),
