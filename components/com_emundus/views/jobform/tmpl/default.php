...
<div class="job-edit front-end-edit">
    ...
    <form id="form-job" action="<?php echo JRoute::_('index.php?option=com_emundus&task=job.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
	...
	<script type="text/javascript">
        ...
        <div class="button-div">
            ...
            <a href="<?php echo JRoute::_('index.php?option=com_emundus&task=jobform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>            
        </div>
