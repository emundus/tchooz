...
Text::script('COM_EMUNDUS_ONBOARD_ACTION_IMPORT_EXISITING_FNUM_HELP');
...
Text::script('COM_EMUNDUS_ONBOARD_ACTION_IMPORT_IN_PROGRESS');
Text::script('COM_EMUNDUS_ONBOARD_ACTION_IMPORT_PLEASE_WAIT');
Text::script('COM_EMUNDUS_ONBOARD_ERROR_IMPORTING_FILE');
...
Text::script('COM_EMUNDUS_ONBOARD_PROGRDELETE');
