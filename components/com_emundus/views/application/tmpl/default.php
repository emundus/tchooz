...
<div class="ui piled segment">
  <form action="" method="post" name="applicant_form" id="applicant_form" onsubmit="return OnSubmitForm();" >
      ...
      <div class="ui two column grid">
        <div class="column">
          <div class="ui fluid form segment">
            <h3 class="ui header"><?php echo JText::_('COM_EMUNDUS_APPLICATION_APPLICANT'); ?> | <?php echo $this->student->id; ?></h3>
            <div class="content">
                  ...
                  <div class="column">
                    ...
                    <div id="photo">
                      ...
                      <div class="ui buttons"> <a class="modal clean" target="_self" rel="{handler:'iframe',size:{x:window.getWidth()*0.8,y: window.getHeight()*0.8}}" href="<?php echo JURI::base(); ?>index.php?option=com_emundus&amp;task=pdf&amp;user=<?php echo $this->student->id; ?>">
                        <button class="mini ui icon button" data-title="<?php echo JText::_('COM_EMUNDUS_APPLICATION_DOWNLOAD_APPLICATION_FORM'); ?>"> <i class="file icon"></i> </button>
                        </a>
                        <button class="mini ui icon button" data-title="<?php echo JText::_('COM_EMUNDUS_EXPORTS_EXPORT_TO_ZIP'); ?>" onclick="document.pressed=this.name;" name="export_zip"> <i class="archive icon"></i> </button>
                        ...
                        <button class="mini ui icon button" data-title="<?php echo JText::_('COM_EMUNDUS_COMMENTS_ADD_COMMENT'); ?>"> <i class="comment basic icon"></i> </button>
                        ...
                        <button class="mini ui icon button" data-title="<?php echo JText::_('COM_EMUNDUS_MAILS_SEND_EMAIL'); ?>"> <i class="mail basic icon "></i> </button>
                        </a> </div>
                    </div>
                  </div>
                  <div class="column">
        ...
        <div class="column">
          <div class="ui fluid form segment">
            ...
            foreach($this->userCampaigns as $campaign){
                ...
                ?>
              <a data-title="<?php echo JText::_('COM_EMUNDUS_APPLICATION_SUBMITTED'); ?>" data-content="<?php echo JText::_('JNO'); ?>" href="#" title="" >
              <?php
                    ...
                    ?>
              <a data-title="<?php echo JText::_('COM_EMUNDUS_APPLICATION_SUBMITTED'); ?>" data-content="<?php echo JText::_('JYES'); ?>" href="#" title="" >
              <?php
                        echo '<img style="border:0;" src="'.JURI::base().'media/com_emundus/images/icones/tick.png" />
							</a>';
                        ?>
              <a data-title="<?php echo JText::_('COM_EMUNDUS_APPLICATION_RESULT_SENT'); ?>" data-content="<?php echo JText::_('JNO'); ?>" href="#" title="" >
              <?php
              ...
              <?php
                                ...
                                ?>
              <a data-title="<?php echo JText::_('COM_EMUNDUS_APPLICATION_RESULT_SENT'); ?>" data-content="<?php echo JText::_('JYES'); ?>" href="#" title="" >
              <?php
                    ...
                    ?>
              <a data-title="<?php echo JText::_('COM_EMUNDUS_DECISION_FINAL_GRADE'); ?>" data-content="<?php echo $contenu; ?>" href="#" title="" >
              <?php
    ...
    <div class="ui fluid accordion">
      ...
      <div class="title" id="em_application_attachments"> <i class="dropdown icon"></i> <?php echo JText::_('COM_EMUNDUS_ATTACHMENTS_ATTACHMENTS').' - '.$this->attachmentsProgress." % ".JText::_("COM_EMUNDUS_APPLICATION_SENT"); ?> </div>
      <div class="content">
        <div class="actions">
          <button class="ui left red icon button" data-title="<?php echo JText::_('COM_EMUNDUS_ATTACHMENTS_DELETE_SELECTED_ATTACHMENTS'); ?>" onclick="document.pressed=this.name;" name="delete_attachments"> <i class="trash icon"></i> </button>
          <?php
      ...
      <div class="active title" id="em_application_forms"> <i class="dropdown icon"></i> <?php echo JText::_('COM_EMUNDUS_APPLICATION_APPLICATION_FORM').' - '.$this->formsProgress." % ".JText::_("COM_EMUNDUS_APPLICATION_COMPLETED"); ?> </div>
      <div class="active content">
        <div class="actions"> <a class="modal clean" target="_self" rel="{handler:'iframe',size:{x:window.getWidth()*0.8,y: window.getHeight()*0.8}}" href="<?php echo JURI::base(); ?>/index.php?option=com_emundus&amp;task=pdf&amp;user=<?php echo $this->student->id; ?>">
          <button class="ui icon button" data-title="<?php echo JText::_('COM_EMUNDUS_APPLICATION_DOWNLOAD_APPLICATION_FORM'); ?>"> <i class="large file icon"></i> </button>
          </a>
          <button class="ui icon button" data-title="<?php echo JText::_('COM_EMUNDUS_EXPORTS_EXPORT_TO_ZIP'); ?>" onclick="document.pressed=this.name;" name="export_zip"> <i class="large archive icon"></i> </button>
        </div>
        <?php echo $this->forms; ?> </div>
      <div class="title" id="em_application_comments"> <i class="dropdown icon"></i> <?php echo JText::_('COM_EMUNDUS_COMMENTS'); ?> </div>
      <div class="content">
        <div class="actions"> <a class="modal clean" target="_self" rel="{handler:'iframe',size:{x:window.getWidth()*0.8,y: window.getHeight()*0.8}}" href="<?php echo JURI::base(); ?>/index.php?option=com_fabrik&amp;c=form&amp;view=form&amp;formid=89&amp;tableid=92&amp;rowid=&amp;jos_emundus_comments___applicant_id[value]=<?php echo $this->student->id; ?>&amp;student_id=<?php echo $this->student->id; ?>&amp;tmpl=component&amp;iframe=1">
          <button class="ui button teal submit labeled icon" data-title="<?php echo JText::_('COM_EMUNDUS_COMMENTS_ADD_COMMENT'); ?>"> <i class="icon edit"></i><?php echo JText::_('COM_EMUNDUS_COMMENTS_ADD_COMMENT'); ?> </button>
          </a> </div>
