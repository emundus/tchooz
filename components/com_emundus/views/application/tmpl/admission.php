...
if (version_compare(JVERSION, '4.0', '>')) {
	Factory::getApplication()->getSession()->set('application_layout', 'admission');
}
else {
	Factory::getSession()->set('application_layout', 'admission');
}
            ...
            <h3 class="panel-title">
				...
				<?php if (EmundusHelperAccess::asAccessAction(8, 'c', $this->_user->id, $this->fnum)): ?>
                    <a class="  clean" target="_blank"
                       href="<?php echo JURI::base(); ?>index.php?option=com_emundus&controller=admission&task=pdf_admission&user=<?php echo $this->student->id; ?>&fnum=<?php echo $this->fnum; ?>">
                    ...
                    <div class="form" id="form">
						<?php if (!empty($this->url_form)): ?>
                            ...
                            <iframe id="iframe" class="embed-responsive-item" src="<?php echo $this->url_form; ?>"
                                    align="left" frameborder="0" height="600"
