                        ...
                        <a id="download-pdf" class="  clean" target="_blank"
                           href="<?php echo JURI::base(); ?>index.php?option=com_emundus&task=pdf&user=<?php echo $this->sid; ?>&fnum=<?php echo $this->fnum; ?>">
                            <button class="btn btn-default"
                                    ...
                                    title="<?= JText::_('COM_EMUNDUS_APPLICATION_DOWNLOAD_APPLICATION_FORM'); ?>"><span
                ...
                <div class="em-flex-row em-border-bottom-neutral-300" style="overflow:hidden; overflow-x: auto;">
					...
					<?php foreach ($pids as $pid) : ?>
						<?php if (is_array($pid->data)) : ?>
							...
							<?php endforeach; ?>
						<?php else : ?>
                            <div id="tab_link_<?php echo $pid->data->pid; ?>"
                                 onclick="updateProfileForm(<?php echo $data->pid ?>)"
                                 class="em-mr-16 profile_tab em-flex-row em-light-tabs em-pointer mb-2">
                                <p class="em-font-size-14 em-neutral-600-color" title="<?php echo $pid->data->label; ?>"
