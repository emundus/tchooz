...
if (!empty($attachment_types)) :?>
    ...
    <?php foreach ($fnums as $fnum => $fnumInfo) :?>
        <form action="<?= JURI::base(); ?>index.php?option=com_emundus&controller=application&format=raw&task=upload_attachment" method="post" enctype="multipart/form-data" onsubmit="return AIM.submit(this, {'onStart' : startCallback, 'onComplete' : completeCallback})">
            <div>
                <?= $attachment_types; ?>
...
<hr /><ul class="em_attachments_list">
