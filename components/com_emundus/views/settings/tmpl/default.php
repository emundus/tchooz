...
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_GENERAL_SAVE');
JText::script('COM_EMUNDUS_ACTIONS_CLEAR_BTN');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_GENERAL_UNSAVED');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_GENERAL_UNSAVED_MUST_TEST_MAIL');
JText::script('COM_EMUNDUS_ONBOARD_WARNING');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_GENERAL_SAVE_SUCCESS');
JText::script('COM_EMUNDUS_ONBOARD_SUCCESS');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_THEME_SAVE_SUCCESS');
JText::script('COM_EMUNDUS_ONBOARD_CANCEL_UPDATES');
JText::script('COM_EMUNDUS_ONBOARD_KEEP_NOTIFICATION');
JText::script('COM_EMUNDUS_ERROR');
JText::script('COM_EMUNDUS_MULTISELECT_NOKEYWORDS');
JText::script('COM_EMUNDUS_MULTISELECT_ADDKEYWORDS');
...
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_MENUS_EMAIL');
Jtext::script('COM_EMUNDUS_FORM_BUILDER_ELEMENT_PROPERTIES_CONTENT');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_MENUS_MANAGE_FILES');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_MENUS_SUPPL_MOD');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_MENUS_INTEG');
#Jtext::script('COM_EMUNDUS_ONBOARD_TRANSLATION_TOOL_TRANSLATIONS'); --- déjà fait plus haut

Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_PARAM_SITE');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_IMG_SITE');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_THEME_SITE');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_ANALATICS');

Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_AUTO_SAVE');

Jtext::script('COM_EMUNDUS_OPTIONAL');

Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_MANAG_SERVER_MAIL');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_EMAIL_HELPTEXT');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_TOGGLE_MAILONLINE');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_TOGGLE_DEFAULT_CONFIG');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_TOGGLE_CUSTOM_CONFIG');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_WARNING');
Jtext::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_PORT_WARNING');
Jtext::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_PORT_WARNING_HELPTEXT_TITLE');
Jtext::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_PORT_WARNING_HELPTEXT_BODY');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_SUBSECTION_EMAIL_ADRESS');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_SUBSECTION_SERVER_EMAIL_CONF');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_SUBSECTION_SERVER_EMAIL_CONF_ADVICE');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_TEST_MAIL_ERROR');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_TEST_MAIL_SUCCESS');
JText::script('COM_EMUNDUS_ONBOARD_DOSSIERS_CLOSE');
JText::script('COM_EMUNDUS_CLICK_HERE_INFO');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_TEST_BT');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_CUSTOM_MODEL_BT');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_CUSTOM_PLACEHOLDER_MAILFROM_NAME');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_CUSTOM_PLACEHOLDER_MAILFROM_DOMAIN');

Jtext::script('COM_EMUNDUS_SURE_TO_DISABLE');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_SURE_TO_DISABLE_TEXT');

Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CAMPAIGN_PAGE');
#JText::script('COM_EMUNDUS_ONBOARD_CONTENT_TOOL_FOOTER'); --- déjà fait plus haut
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_RGPD');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_RGPD_HELPTEXT');
...
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_SHARE_FILE');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_MAIL_GENERATION/PUBLISHING');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_EXPERT_INVITE');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_RULES_OF_PAY_PRODUCT');

Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_SAVE_CLOUD_FILE');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_ELECTRONIC_VERIF');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_API_INSEE');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_ADD_PIPE');
Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_PAYMENT');

Jtext::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_TRANSLATIONS');
#JText::script('COM_EMUNDUS_ONBOARD_TRANSLATION_TOOL_ORPHELINS'); --- déjà fait plus haut

JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_FIELD_NAME'); // Nom du site
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_LANG_PRIM'); // Langue principale
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_OTHER_LANG'); // Autres Langues
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_DESC'); // Description du site
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_TIMEZONE'); // Fuseau horaire
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_TIMEZONE_LAND'); // Pays
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_TIMEZONE_CITY'); // Ville
JText::script('COM_EMUNDUS_ONBOARD_BUILDER_BIRTHDAY_FORMAT'); // Format de date
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_DATE_FORMAT_D/M/Y'); // Format de date
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_DATE_FORMAT_M/D/Y'); // Format de date
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_DATE_FORMAT_Y/M/D'); // Format de date
JText::script('COM_EMUNDUS_ATTACHMENTS_KEYWORDS'); // Mots clés
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SITE_NUMBER_LINES_LISTES'); // Nombre de lignes dans les listes

JText::script('COM_EMUNDUS_GLOBAL_PARAMS_THEME_SITE_ADV_PARA'); // Paramètres avancés
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_ANALATICS_HELPTEXT'); // helptext pour google analytics

JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CAMP_SHOW'); // Afficher les campagnes
...
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CAMP_GROUP_BY'); // campagne Regrouper par
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CAMP_GROUP_BY_MONTH'); // mois
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CAMP_GROUP_BY_YEAR'); // année

JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CAMP_ORGANIZE_BY'); // Organiser par
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CAMP_ORGANIZE_BY_LAUCH_DATE'); // date de lancement
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CAMP_ORGANIZE_BY_CLOSE_DATE'); // date de fin
...
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CONTENT_CANDIDATE_INTRO'); // Introduction pour le candidat
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CONTENT_CANDIDATE_MULTIPLE_FILES'); // candidat a droit a Plusieurs dossiers
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CONTENT_CANDIDATE_EDIT_UNTIL_DEADLINE'); // candidat peut modifier jusqu'à la date limite
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CONTENT_CANDIDATE_SHOW_HISTORY'); // Afficher l'historique des candidatures

JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CONTENT_ALERT_MOD_SIMUL'); // Alerte de modification simultanée
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CONTENT_NUM_FILES_IN_LIST'); // Nombre de fichiers dans la liste
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CONTENT_SHOW_DELETED_FILES'); // Afficher les fichiers supprimés
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CONTENT_ALLOW_LOCK_PDF'); // Autoriser les PDF verrouillés
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTIONS_CONTENT_ALLOW_COPY_OF_FILES'); // Autoriser la copie des fichiers

## EMAILS ##
JText::script('COM_EMUNDUS_FILTERS_CHECK_NONE');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_ENABLE');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_SENDER');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_REPLYTO');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_REPLY_TO_NAME');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_SENDER_NAME');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_GLOBAL');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_CUSTOM');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_CONFIGURATION');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_CONFIGURATION_SMTP_HOST');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_CONFIGURATION_SMTP_PORT');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_CONFIGURATION_SMTP_SECURITY');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_CONFIGURATION_SMTP_ENABLE');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_CONFIGURATION_SMTP_USERNAME');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_CONFIGURATION_SMTP_PASSWORD');
JText::script('COM_EMUNDUS_ERROR_SMTP_HOST');
JText::script('COM_EMUNDUS_ERROR_SMTP_PORT');
JText::script('COM_EMUNDUS_ERROR_SMTP_AUTH');
JText::script('COM_EMUNDUS_ERROR_SMTP_TOGGLE_AUTH');
JText::script('COM_EMUNDUS_ERROR_MAIL_FUNCTION');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_NEED_TEST');
JText::script('COM_CONFIG_SENDMAIL_SUCCESS');
JText::script('COM_CONFIG_SENDMAIL_ERROR');
JText::script('COM_CONFIG_SENDMAIL_SUCCESS_FALLBACK');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_SAVE_ANYWAY');
JText::script('COM_CONFIG_SENDMAIL_SUBJECT');
JText::script('COM_CONFIG_SENDMAIL_BODY');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_CHECK_INPUT_MAIL');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_CHECK_INPUT_MAIL_NO');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_CHECK_INPUT_MAIL_NAME_EXP');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_CHECK_INPUT_MAIL_DOMAIN_EXP');
JText::script('COM_EMUNDUS_GLOBAL_PARAMS_SECTION_MAIL_CHECK_INPUT_MAIL_YES');

JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_REPLYTO_ADRESS_HELPTEXT');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_REPLYTO_HELPTEXT');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_SENDER_ADRESS_HELPTEXT');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_HOSTSMTP_HELPTEXT');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_PORT_HELPTEXT');
JText::script('COM_EMUNDUS_ONBOARD_SETTINGS_EMAIL_SECURITY_HELPTEXT');
## END ##
