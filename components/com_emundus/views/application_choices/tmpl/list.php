...
Text::script('COM_EMUNDUS_APPLICATION_CHOICES_UPDATE_STATUS_COMMENT');
Text::script('COM_EMUNDUS_APPLICATION_CHOICES_UPDATE_STATUS_COMMENT_HELP');
...
Text::script('COM_EMUNDUS_APPLICATION_CHOICES_EXPORT_EXCEL');
Text::script('COM_EMUNDUS_APPLICATION_CHOICES_EXPORT_EXCEL_ALL');
