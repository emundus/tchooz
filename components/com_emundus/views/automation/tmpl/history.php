...
Text::script('COM_EMUNDUS_AUTOMATION_ACTION_MESSAGES');
Text::script('COM_EMUNDUS_AUTOMATION_ACTION_MESSAGE_TYPE_INFO');
Text::script('COM_EMUNDUS_AUTOMATION_ACTION_MESSAGE_TYPE_WARNING');
Text::script('COM_EMUNDUS_AUTOMATION_ACTION_MESSAGE_TYPE_ERROR');
Text::script('COM_EMUNDUS_NO_EXECUTION_MESSAGES');
