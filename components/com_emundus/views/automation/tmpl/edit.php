...
Text::script('COM_EMUNDUS_AUTOMATION_MULTIPLE_ASYNC_ACTIONS_WARNING');
Text::script('COM_EMUNDUS_AUTOMATION_ACTION_ASYNCHRONOUS');
...
Text::script('COM_EMUNDUS_ACTION_UPDATE_CART_PRODUCTS_PARAMETER_MANDATORY_LABEL');
Text::script('COM_EMUNDUS_AUTOMATION_SAVE_ERROR');
Text::script('COM_EMUNDUS_AUTOMATION_ERROR_ACTION_INVALID_PARAMETERS');
Text::script('COM_EMUNDUS_AUTOMATION_EVENT_FIELD_CHOICE_IS_NEW');
Text::script('COM_EMUNDUS_AUTOMATION_EVENT_FIELD_CHOICE_STATE');
Text::script('COM_EMUNDUS_AUTOMATION_EVENT_FIELD_CHOICE_ORDER');
Text::script('COM_EMUNDUS_AUTOMATION_EVENT_FIELD_CHOICE_CAMPAIGN');
