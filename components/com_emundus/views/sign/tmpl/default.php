...
Text::script('COM_EMUNDUS_ONBOARD_SIGN_FILTER_CONNECTOR_LABEL');
Text::script('COM_EMUNDUS_ONBOARD_SIGN_FILTER_CONNECTOR_ALL');
Text::script('COM_EMUNDUS_ONBOARD_SIGN_FILTER_SIGNED_DATE_LABEL');
Text::script('COM_EMUNDUS_ONBOARD_SIGN_FILTER_CREATION_DATE_LABEL');
Text::script('COM_EMUNDUS_ONBOARD_SIGN_FILTER_REMINDER_DATE_LABEL');
