...
Text::script('COM_EMUNDUS_IMPORT_REFERENTIAL_EXAMPLE_LABEL');
Text::script('COM_EMUNDUS_IMPORT_REFERENTIAL_EXAMPLE_ID');
Text::script('COM_EMUNDUS_IMPORT_ROW_WARNING');
