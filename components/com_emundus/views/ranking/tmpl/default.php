...
Text::script('COM_EMUNDUS_RANKING_HIERARCHY_FORM_ID_FINISHED');
Text::script('COM_EMUNDUS_RANKING_HIERARCHY_FORM_ID_NOT_FINISHED');
...
<div class="em-flex-row em-w-100 em-h-100 em-flex-align-start">
    ...
    <div class="em-p-0-12 em-w-100 em-h-100">
        ...
        <p class="em-neutral-600-color em-mt-8 em-mb-8"><?= Text::_('COM_EMUNDUS_CLASSEMENT_HIERARCHY_LEVEL') . $this->hierarchy['label'] . ' - ' . Text::_('COM_EMUNDUS_CLASSEMENT_RANKER') . ' ' . $this->user->name ?></p>
        <div id="em-component-vue"
             component="Ranking/rankings"
             user="<?= $this->user->id ?>"
