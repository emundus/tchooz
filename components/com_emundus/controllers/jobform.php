...
class EmundusControllerJobForm extends EmundusController {
    ...
    public function save() {
        ...
        if ($data === false) {
            ...
            $this->app->setUserState('com_emundus.edit.job.data', $jform, array());

            // Redirect back to the edit screen.
            $id = (int) $this->app->getUserState('com_emundus.edit.job.id');
        ...
        if ($return === false) {
            // Save the data in the session.
            $this->app->setUserState('com_emundus.edit.job.data', $data);
    ...
    function cancel() {
        ...
        $editId = (int) $this->app->getUserState('com_emundus.edit.job.id');
