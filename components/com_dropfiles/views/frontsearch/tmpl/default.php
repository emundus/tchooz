...
JText::script('COM_DROPFILES_SEARCH_FILES_CATEGORY_FILTERING');
...
$doc->addScript(JUri::base() . 'components/com_dropfiles/assets/js/jquery-ui-1.13.0.min.js');
...
$doc->addScriptDeclaration('ga_download_tracking="' . $this->gaDownloadTracking . '";');
$doc->addScript(JUri::base() . 'components/com_dropfiles/assets/js/search_filter.js');
$doc->addScript(JUri::base() . 'components/com_dropfiles/assets/js/gatracking.js');
                            ...
                            if (count($this->categories) > 0) {
                                foreach ($this->categories as $key => $category) {
                                    if (!empty($excludeCategory)) {
                                        ...
                                        if (!empty($filters['catid']) && (int) $filters['catid'] === (int)$category->id) {
