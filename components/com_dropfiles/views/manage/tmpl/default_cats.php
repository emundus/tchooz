        ...
        <?php if ($this->canDo->get('core.create')) : ?>
            <div id="newcategory"
                ...
                <?php if (($this->params->get('google_credentials', '') !== '') ||
                    ($this->params->get('dropboxAccessToken', '') !== '') ||
                    ...
                    <ul class="dropdown-menu pull-right">
                        ...
                        <?php } ?>
                        <?php if ($this->params->get('dropboxAccessToken', '') !== '') { ?>
                            <li>
            ...
            <?php if ($this->params->get('google_credentials') !== null || $this->params->get('dropboxAccessToken', '') !== '' || $this->params->get('onedriveCredentials', '') !== '' ||
                ($this->params->get('onedriveBusinessKey', '') !== '' && $this->params->get('onedriveBusinessSecret', '') !== '' &&
                    isset($this->params['onedriveBusinessConnected']) && (int) $this->params['onedriveBusinessConnected'] === 1)) : ?>
            <div class="dropfiles-sync-buttons">
                ...
                <?php } ?>
                <?php if ($this->params->get('onedriveCredentials', '') !== '') { ?>
                    <button href="#" id="btn-sync-onedrive" data-loading-text="Syncing with OneDrive" title="Syncing with OneDrive"
