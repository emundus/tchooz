...
class DropfilesControllerFrontonedrive extends JControllerLegacy
{
    ...
    public function index()
    {
        ...
        $path_dropfilescloudhelper = JPATH_ADMINISTRATOR . '/components/com_dropfiles/helpers/dropfilescloud.php';
        JLoader::register('DropfilesCloudHelper', $path_dropfilescloudhelper);
