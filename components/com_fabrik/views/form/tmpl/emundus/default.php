...
<div
    class="emundus-form !tw-p-6 tw-rounded-coordinator-cards tw-shadow-standard tw-border tw-border-neutral-300 !tw-bg-white <?php echo $pageClass; ?>">
            ...
            <?php if ($this->params->get('show-title', 1)) : ?>
                <div class="tw-flex tw-flex-row tw-relative fabrik-page-header">
                    <?php if ($this->display_comments)
                    {
                        ?>
                        <div
                            class="fabrik-element-emundus-container tw-absolute tw--left-[24px] tw-top-1 tw-flex tw-flex-row tw-justify-items-start tw-items-start tw-mr-5">
...
if ($this->display_comments)
{
    ...
    <aside id="aside-comment-section"
        ...
        <div class="tw-flex tw-flex-row tw-relative tw-h-full">
            <span
                class="open-comment material-symbols-outlined tw-cursor-pointer tw-absolute tw-top-8 tw-bg-profile-full tw-rounded-l-lg tw-text-neutral-300"
                onclick="openCommentAside()">
                comment
            </span>
            <span
                class="close-comment material-symbols-outlined tw-cursor-pointer tw-absolute tw-top-8 tw-bg-profile-full tw-rounded-l-lg tw-text-neutral-300"
                onclick="openCommentAside()">
                close
            </span>
