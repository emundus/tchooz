...
class ProfilesController extends ApiController
{
    ...
    public function displayList()
    {
	    ...
	    if (\array_key_exists('is_applicant', $apiFilterInfo)) {
		    $this->modelState->set('filter.is_applicant', $filter->clean($apiFilterInfo['is_applicant'], 'INT'));
	    }
	    ...
	    if (\array_key_exists('campaign', $apiFilterInfo)) {
		    $this->modelState->set('filter.campaign', $filter->clean($apiFilterInfo['campaign'], 'INT'));
	    }
