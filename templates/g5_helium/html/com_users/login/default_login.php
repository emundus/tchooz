...
<div class="com-users-login login">
    ...
    <div class="page-header flex flex-column items-center">
        <?php if (file_exists('images/custom/favicon.png')) : ?>
            <a href="index.php" alt="Logo" class="em-profile-picture mb-2" style="width: 50px;height: 50px;background-image: url('images/custom/favicon.png')">
            </a>
        <?php endif; ?>
        <h1 class="mb-3">
    ...
    <form action="<?php echo (!empty($this->redirect)) ? 'index.php?option=com_users&task=user.login&redirect='.$this->redirect : 'index.php?option=com_users&task=user.login'; ?>" method="post" class="form-validate form-horizontal well" id="com-users-login__form">
