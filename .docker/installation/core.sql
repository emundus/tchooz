...
INSERT INTO `jos_guidedtours` (`id`, `title`, `uid`, `description`, `ordering`, `extensions`, `url`, `created`, `created_by`, `modified`, `modified_by`, `checked_out_time`, `checked_out`, `published`, `language`, `access`) VALUES
...
--
-- Table structure for table `jos_webauthn_credentials#__webauthn_credentials`
--
