	...
	public function onBeforeApiRoute(BeforeApiRouteEvent $event): void
	{
		...
		if (in_array('GET', $allowedVerbs))
		{
			$routes = array_merge($routes, [
				...
				new Route(['GET'], 'v1/emundus/fileuploads/:id/download', 'fileuploads.download', ['id' => '(\d+)'], ['component' => 'com_emundus']),
				new Route(['GET'], 'v1/emundus/fileuploads/:id', 'fileuploads.displayItem', ['id' => '(\d+)'], ['component' => 'com_emundus']),
				new Route(['GET'], 'v1/emundus/attachments', 'attachments.displayList', [], ['component' => 'com_emundus']),
