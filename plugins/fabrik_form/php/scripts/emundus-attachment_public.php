...
$key_id = $app->getInput()->get('keyid');
$user_id = $app->getInput()->getInt('jos_emundus_uploads___user_id',0);
$fnum = $app->getInput()->getString('jos_emundus_uploads___fnum','');
$sid = $app->getInput()->getInt('sid',0);
$attachment_id = $app->getInput()->getInt('jos_emundus_uploads___attachment_id',0);
$formid      = $app->getInput()->getInt('formid', 0);
$article_id  = $app->getInput()->getInt('article_id', 61);
