...
$recipients[] = (object) array('email' => $user->email, 'id' => $user->id, 'email_tmpl' => 'eltanc_welcome');
//$recipients[] = (object) array('email' => 'benjamin@rivalland.info', 'id' => 62, 'email_tmpl' => 'eltanc_welcome_inform');
$recipients[] = (object) array('email' => 'eleanor.harley@diplomatie.gouv.fr', 'id' => 62, 'email_tmpl' => 'eltanc_welcome_inform');
