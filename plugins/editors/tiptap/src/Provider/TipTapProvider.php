...
namespace Joomla\Plugin\Editors\TipTap\Provider;
...
use Joomla\Plugin\Editors\TipTap\PluginTraits\DisplayTrait;
 ...
 * @since   5.0.0
 */
final class TipTapProvider extends AbstractEditorProvider
{
    use DisplayTrait;
